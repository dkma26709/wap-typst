// Bretonnia 1.6 - re-typeset from the Warhammer Armies Project PDF.
...
#show: book.with(title: "Warhammer Armies Project — Bretonnia 1.6")
...
#colophon((
  [
    ...
    Bretonnia*, version 1.6 — written and freely distributed by Mathias
    Eliasson.
  ],
  [
...
On a turn that a unit in Lance Formation makes a successful charge, all models with this special rule gain the Fight in Extra Ranks (1) special rule, and every rider that gets to fight can make up to 3 Supporting Attacks rather than 1. In addition, they add their current Rank Bonus to the Strength of the Impact Hits they inflict.
]

#upgrade("THE BLESSING OF THE LADY", none)[
Models with this special rule have a 6+ Ward save. This is increased to a 5+ Ward save against missile attacks. Models with the Grail Vow always have a 5+ Ward save. Models with the Blessing of the Lady will lose it if they flee for any reason or refuse a challenge.
]

#upgrade("CHIVALROUS VOWS", none)[
Your Army General must always be a model with one of the Chivalrous Vows below.

\- *The Knight's Vow:* Models with the Knight's Vow have Immunity (Panic) caused by friendly models without a Chivalrous Vow. In addition, they may only join units with the Knight's Vow.
...
\- *The Questing Vow:* Models with the Questing's Vow have Immunity (Panic) caused by friendly models without a Chivalrous Vow and may re-roll failed Psychology tests. In addition, they may only join units with the Knight's Vow, the Crusader's Vow or the Questing Vow. Furthermore, they ignore Initiative penalties from using great weapons in any turn that they charge, but they may not use a heavy lance (unless specified).

\- *The Grail Vow:* Models with the Grail Vow have the Immunity (Psychology) and Magical Attacks special rules. In addition, they may only join units with the Knight's Vow, the Crusader's Vow, the Questing Vow or the Grail Vow. Furthermore, characters with the Grail Vow add +1 to their Leadership.
]
...
#spell("FAVOUR OF THE LADY", "Lore Attribute")[If a spell from the Lore of the Lady is successfully cast on a friendly unit that has the Blessing of the Lady, it may re-roll Ward save rolls of 1 until the start of the next Bretonnian Magic phase.]

#spell("STEED OF THE LADY", "Signature Spell", cast: "7+")[_Steed of the Lady_ is a *conveyance* spell with a range of 18" that targets Cavalry or Monstrous Cavalry with a Chivalrous Vow. The target may immediately make a normal move as if it were the Remaining Moves sub- phase.]
...
#spell("THE LADY'S GIFT", 1, cast: "6+")[Remains in Play. _The Lady's Gift_ is an *augment* spell with a range of 18" that targets a unit with a Chivalrous Vow. While this spell is in effect, the target unit has the Regeneration (6+) special rule.]
...
#spell("SACRED LIGHTNING", 2, cast: "7+")[_Sacred Lightning_ is a *magic missile* with a range of 24" that causes D6 Strength 3 Hits with the Lightning Attacks special rule.]

#spell("BURNING GAZE", 2, cast: "8+")[_Burning Gaze_ is a *direct damage* spell. Extend a straight line, 30" in length, within the caster's forward arc and directly away from their base. Any model whose base falls under the line suffers a Strength 5 hit with the Flaming Attacks special rule.]

#spell("THE CURSE OF THE LADY", 3, cast: "9+")[_The Curse of the Lady_ is a *hex* spell with a range of 24". The target must pass a Leadership test with a \-2 modifier or suffer \-1 Weapon Skill, Initiative and Leadership for every point they fail the test by (down to a minimum of 1).]
...
#spell("THE LADY'S VIRTUE OF VALOUR", 4, cast: "12+")[_The Lady’s Virtue of Valour_ is an *augment* spell with a range of 18" that targets a unit with a Chivalrous Vow. Until the start of the caster's next Magic phase, all models in the unit (excluding mounts) gain +1 To Hit and the Devastating Charge special rule.]

#spell("SUMMONING THE FAY", 4, cast: "15+")[_Summoning the Fay_ is a *summoning* spell with a range of 18" that brings a unit of Spirits of the Fay into play. Roll D6+4. This is how many models comprise the new unit.]
]
#upgrade-chapter("VIRTUES OF THE CHIVALRIC KNIGHT")[
...
#upgrade("VIRTUE OF KNIGHTLY ARDOUR", 30)[The Knight and unit he is with may respond to a charge to his unit’s front by counter charging if he can pass a Leadership test and roll higher than the enemy for the charge distance. If he succeeds, count the enemy’s charge as a failed one and move the Knight's unit as per a normal charge.]
...
#upgrade("VIRTUE OF UTTER SERENTIY", 20)[All enemy Wizards within 12" of this Knight suffer \-1 to their casting result.]
...
#upgrade("VIRTUE OF PURITY", 15)[The Knight gains a +1 bonus to their Ward save from the Blessing of the Lady.]
...
#magic-weapon("WYRMLANCE", 30)[Heavy lance. The wielder of the Wyrmlance gains a Strength 3 Breath Weapon with the Flaming Attacks special rule. In addition, all attacks made with the Wyrmlance have the Flaming Attacks special rule.]

#magic-weapon("BIRTH-SWORD OF CARCASSONNE", 25)[The Birth-sword of Carcassonne gives +1 Strength to the wielder. Enemies wounded by the sword must re- roll any successful Armour saves.]

#magic-weapon("SWORD OF THE QUEST", 25)[Questing Vow only. The Sword of the Quest may be used as either a hand weapon or a great weapon, decided at the start of each round combat. All attacks made by the Sword of the Quest have the Ignores Armour Saves special rule.]

#magic-weapon("HEARTWOOD LANCE", 25)[Heavy lance. The Heartwood Lance allows the bearer to re-roll all failed rolls to wound.]

#magic-weapon("FRONTIER AXE", 25)[Great weapon. All attacks made with this weapon have the Multiple Wounds (2) special rule.]

#magic-weapon("THE VIRTUOUS LANCE", 25)[Heavy Lance. This lance gives the wielder the Mighty Blow (1) and Multiple Wounds (D3) special rules when charging.. When fighting Monstrous Creatures and Monsters, once you have established how many wounds have been inflicted, roll a D6 and add the number of wounds caused to the score. If the total is equal to 6 or more, remove the model as a casualty. Note that the wielder must cause at least one unsaved Wound for this rule to take effect.]
...
#magic-weapon("LANCE OF ARTOIS", 15)[Heavy lance. The Lance of Artois gives the wielder the Killing Blow special rule on turns in which the character charges.
...
#magic-weapon("SWORD OF THE STOUT HEARTED", 10)[Great weapon. This weapon gives the wielder the Immunity (Psychology) special rule.]
]

#magic-item-section("armour")[
#magic-armour("ARMOUR OF THE MIDSUMMER SUN", 35)[Heavy armour. Opponents suffer a \-1 penalty To Hit the wearer of the Armour of the Midsummer Sun with both missile and close combat attacks.]

#magic-armour("GROMRIL GREAT HELM", 30)[The Gromril Great Helm gives the wearer a 6+ armour save and allows them to re-roll failed armour saves.]

#magic-armour("ARMOUR OF AGILULF", 25)[Heavy armour and shield (shield must be used at all times). The wearer of the Armour of Agilulf gains Weapon Skill 10.]

#magic-armour("CUIRASS OF FORTUNE", 25)[Heavy armour. The Knight may re-roll 1's when rolling To Hit, To Wound and when making armour saves.]

#magic-armour("ANOINTED ARMOUR", 15)[Infantry or Cavalry only. Heavy armour. The wearer of this armour may re-roll failed Ward saves as long as they have the Blessing of the Lady.]

#magic-armour("THE GRAIL SHIELD", 15)[Grail Vow only. Shield. The wearer gains +1 to the Ward save gained from the Blessing of the Lady.]

#magic-armour("HELM OF THE DRAGON SLAYER", 15)[This armour gives the wearer a 6+ armour save. In addition, the Ward Save from the Blessing of the Lady is increased to 5+ against close combat attacks and the wearer gains the Immunity (Flaming Attacks) special rule.]

#magic-armour("ORCBANE SHIELD", 15)[Shield. Any Orc or Goblin unit within 12" of the model with the Orcbane Shield that must take an Animosity test fails it on a 1\-2 instead of a 1.]

#magic-armour("GILDED CUIRASS", 10)[Grail Vow only. Heavy armour. The wearer of the Gilded Cuirass gains the Regeneration (6+) special rule.]

#magic-armour("IRONSPIKE SHIELD", 5)[Shield. Whenever an enemy model rolls a natural 1 To Hit against the bearer of this shield, they immediately suffer a Strength 3 Hit with the Armour Piercing (1) special rule.]
]

#magic-item-section("talisman")[
#talisman("SIRIENNE'S LOCKET", 55)[Bretonnian Lord only. A model with Sirienne's Locket has Immunity (Killing Blow, Multiple Wounds) and can never suffer more than one wound in any one phase. After the first wound in that phase is suffered, all subsequent wounds suffered during that phase are ignored. The bearer can still be run down by pursuing enemies as normal, and may still be affected as normal by other "instant kill" attacks.]
...
#talisman("INSIGNIA OF THE QUEST", 25)[Questing Vow only. If the bearer of the Insignia of the Quest is ever reduced to 1 Wound, then the Knight instantly gains a Ward Save (3+) as long as they remain at 1 Wound. If the character suffers an attack that would kill him before he has gained this Ward save (such as Killing Blow or Multiple Wounds), he will be reduced to 1 Wound, then may attempt his Ward Save (3+) to stay alive and nullify any further wounds caused by the same hit.]

#talisman("TOKEN OF THE DAMSEL", 20)[Lord or Paladin only. One use only. The wearer of the Token of the Damsel ignores the first wounding Hit (after saves) suffered during the game.]

#talisman("LUCKY HEIRLOOM", 15)[Once per Close Combat phase, the bearer of the Lucky Heirloom can re-roll a single failed roll To Hit or To Wound, or re-roll a failed Armour Save or Ward Save roll.]
...
#talisman("GRAIL PENDANT", 10)[Models with the Grail Vow only. One use only. When the wearer of the Grail Pendant loses their last Wound, roll a D6. On a roll of 2+, the Wound is not lost.]
]

#magic-item-section("arcane")[
#arcane-item("SACRAMENT OF THE LADY", 50)[The bearer may use the Sacrament of the Lady at the start of any Bretonnian Magic phase. The model adds 2D3 Power Dice to your power pool, but may not cast any spells that turn.]

#arcane-item("THE SILVER MIRROR", 45)[One use only. When used, the bearer of the Silver Mirror deflects a spell cast at them or the unit they are with back at the enemy caster. The enemy can try to dispel their own spell as normal using any remaining Power dice or Dispel dice. This item has no effect on spells that do not specifically target the bearer or the unit they are with.]

#arcane-item("PRAYER ICON OF QUENELLES", 45)[The bearer of Prayer Icon of Quenelles and the unit they are with gain a +1 bonus to the Ward Save from the Blessing of the Lady.]

#arcane-item("THE VERDANT HEART", 40)[The Verdant Heart gives the bearer a +D3 bonus to the result of their spell casting attempts from the Lore of Life. Roll for each spell casting attempt.]

#arcane-item("FLAMESTRIKE WAND", 35)[Bound Spell, power level 4. This item contains the _Fires of U'Zhul_ spell from the Lore of Fire.]

#arcane-item("HEART OF THE WILDS", 20)[The bearer of this item gains a +2 Casting bonus if they are wholly within a forest or water terrain feature.]

#arcane-item("CHALICE OF MALFLEUR", 15)[At the start of the opponent's Magic phase, the bearer may drink from the Chalice. If they do so, on the roll of a 1 she suffers a wound with no saves allowed, including Ward saves. On a roll of 2\-6, an extra Dispel dice is added to the player's pool.]

#arcane-item("POTION SACRE", 10)[One use only. The Potion Sacre can be used before rolling the dice to cast or dispel a spell. After the dice are rolled, the player may add +1 to the result of one dice. This may cause Ultimate Power or prevent a Miscast.]

#arcane-item("DIADEM OF POWER", 10)[The bearer of this item gains a +1 Casting bonus when casting magical missiles, direct damage or magical vortex spells.]
]

#magic-item-section("enchanted")[
#enchanted-item("THE MANE OF THE PUREBREED", 30)[Model on Warhorse only. The Mane of the Purebreed gives +1 Strength to all Warhorses in the unit the model is with.]
...
#enchanted-item("FALCON-HORN OF FREDEMUND", 20)[One use only. The Horn may be sounded at the start of any Bretonnian turn. Until the start of your next turn, no enemy unit may use the Fly special rule.]

#enchanted-item("THE SEAL OF PARRAVON", 20)[The bearer of the Seal of Parravon will always Hit on a 2+ in close combat.]

#enchanted-item("WYRMBREATH VIAL", 20)[One use only. The bearer gains a Breath Weapon attack with Strength 4 and Flaming Attacks and Magical Attacks special rules.]

#enchanted-item("BATTLE STONE OF THE MARQUIS", 15)[One use only. The Battle Stone may be used at the start of any close combat phase. The bearer (but not any mount) gains +3 Attacks for this round of close combat.]

#enchanted-item("CRUSADER'S CLARION", 15)[Cavalry only. On a turn in which the bearer of the Crusader’s Clarion charge, their mount and all mounts in the unit they have joined may re-roll failed rolls To Wound (including Impact Hits)]

#enchanted-item("ANTLERS OF THE GREAT HUNT", 10)[Lord or Paladin only. The model wearing the Antlers of the Great Hunt and any unit they are with roll an additional dice when pursuing and discard the lowest result.]
...
#enchanted-item("GAUNTLET OF THE DUEL", 10)[Lord or Paladin only. Any challenge issued by the bearer of the Gauntlet of the Duel cannot be refused.]

#enchanted-item("TRESS OF ISOULDE", 10)[One use only. Nominate one enemy Character, Monstrous Creature or Monster in base contact at the beginning of any Close Combat phase (after challenges). The bearer automatically hits that model that Close Combat round, regardless of other modifiers.]
]
...
#magic-standard("BANNER OF THE LADY", 40)[All enemy units in base contact with the bearer of the Banner of the Lady get no combat bonus for ranks.]

#magic-standard("CRUSADER'S TAPESTRY", 40)[Crusader's Vow only. The unit carrying the Crusader’s Tapestry gains the Frenzy special rule.]

#magic-standard("BANNER OF DEFENCE", 25)[As long as the unit is affected by the Blessing of the Lady, all models in a unit with the Banner gain a 6+ Ward save against missile attacks. If the Blessing of the Lady is lost, then the Banner loses this ability.]
...
#magic-standard("ERRANTRY BANNER", 25)[Knights Errant only. All Knights Errant in the unit get a +1 Strength bonus on any turn they charge. However, a unit with this banner suffers \-2 to its Ld for any Impetuous tests.]

#magic-standard("TWILIGHT BANNER", 25)[One use only. The Twilight Banner can be used at the start of any of your Movement phases. For the remainder of the Movement phase, the unit gains the Ethereal special rule.]
...
#unit("BRETONNIAN LORD",
  first: true,
  profiles: (
    (name: "Bretonnian Lord", m: 4, ws: 6, bs: 5, s: 4, t: 4, w: 3, i: 6, a: 4, ld: 9, points: 110),
  ),
...
- May replace the Knights Vow with one of the following:
  ...
  - The Grail Vow +30 points
- May choose one of the following:
  - Heavy lance +8 points
  - Polearm (on foot only) +8 points
...
- May be mounted on one of the following:
  ...
  - Royal Hippogryph +150 points
- May take one Virtue and/or Magic Items up to a total of 100 points
  ],
...
#unit("PROPHETESS OF THE LADY",
  profiles: (
    (name: "Prophetess of the Lady", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 3, i: 3, a: 1, ld: 8, points: 165),
  ),
  troop-type: "Infantry (Character, Human)",
  base-size: "20x20 or 25x25",
  equipment: "Hand weapon",
  magic: "A Prophetess of the Lady is a Level 3 Wizard which can use spells from the Lore of Life, Beasts, Heavens, Light or the Lady.",
  options: [
...
- May be mounted on one of the following:
  ...
  - Pegasus +30 points
  - Unicorn +42 points
  - Sacrosanctum of the Lady (replacing the Grail Damsel) +120 points
...
- May replace the Knights Vow with one of the following:
  - The Crusader's Vow +10 points
  - The Questing Vow +10 points
  - The Grail Vow +20 points
- May choose one of the following:
  - Heavy lance +6 points
  - Polearm (on foot only) +6 points
  - Great weapon +9 points
- May take a shield +2 points
- May be mounted on one of the following:
  - Warhorse +12 points
  - Pegasus +20 points
  - Royal Pegasus +30 points
- May take one Virtue and/or Magic Items up to a total of 50 points
  ],
  special-rules: "Blessing of the Lady, The Knight's Vow, Lance Formation",
  upgrades: (
...
#unit("DAMSEL OF THE LADY",
  profiles: (
    (name: "Damsel of the Lady", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 2, i: 3, a: 1, ld: 7, points: 80),
  ),
  troop-type: "Infantry (Character, Human)",
  base-size: "20x20 or 25x25",
  equipment: "Hand weapon",
  magic: "A Damsel of the Lady is a Level 1 Wizard which can use spells from the Lore of Life, Beasts, Heavens, Light or the Lady.",
  options: [
...
- May take a shield +2 points
- May be mounted on a Horse +12 points
  ],
...
- May take light armour +2 points
  ...
  special-rules: "Loner, Scouts, Sniper",
  order: ("troop-type", "base-size", "equipment", "options", "special-rules"),
)

#unit("PRIESTESS OF SHALLYA",
  profiles: (
    (name: "Priestess of Shallya", m: 4, ws: 2, bs: 2, s: 3, t: 3, w: 2, i: 3, a: 0, ld: 7, points: 75),
  ),
  troop-type: "Infantry (Character, Human)",
  base-size: "20x20 or 25x25",
  options: [
...
#unit("UNICORN",
  ...
  troop-type: "War Beast (Forest Spirit)",
...
- May upgrade one Knight Errant to a Standard Bearer +10 points
  ...
  special-rules-body: (
    rule("Impetuous")[After charges have been declared, if any unit containing one or more models with the Impetuous special rule did not declare a charge but are within charge range of an enemy, then they must take a Leadership test to restrain from charging. If this test is failed, the unit must declare a charge. If the test is passed, it may move normally. In addition, whenever a unit of Knights Errant charge, they have Immunity (Psychology) and may re-roll one of their charge distance dice.],
  ),
...
#unit("MEN-AT-ARMS",
  profiles: (
    (name: "Man-at-Arms", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 6, points: 4),
  ),
  unit-size: "10+",
...
- May upgrade one Longbowman to a Standard Bearer +10 points
  ...
  special-rules: "The Peasant's Duty",
  upgrades: [
- *Braziers:* A unit with this upgrade gain the Flaming Attack special rule for their longbows.
...
#unit("PEASANT MOB",
  profiles: (
    ...
    (name: "Truffle Hound", m: 7, ws: 3, bs: 0, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 3, points: ""),
  ),
  unit-size: "20+",
  troop-type: "Infantry (Human)",
  base-size: "20x20 or 25x25",
...
- May choose one of the following:
  ...
  - Polearms +2 points/model
- May take one include one Truffle Hound for every 10 models in the unit +7 points/Truffle Hound
...
- May upgrade one Peasant to a Standard Bearer +10 points
  ...
  special-rules: "The Peasant's Duty",
  upgrades: [
- *Truffle Hound:* Truffle Hounds have the Frenzy special rule. A unit with one or more Truffle Hounds must place them in the front rank of the unit along with any command group models and/or characters. They may be attacked separately from any other models in the unit.
...
#unit("HERRIMAULTS",
  profiles: (
    (name: "Herrimault", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 6, points: 8),
  ),
  unit-size: "5+",
  troop-type: "Infantry (Human)",
  base-size: "20x20 or 25x25",
...
- May upgrade one Herrimault to a Musician +5 points
  ...
  special-rules: "Loner, Scouts, Skirmishers",
  order: ("unit-size", "troop-type", "base-size", "equipment", "options", "special-rules"),
)
...
#unit("BRIGANDS",
  ...
  options: [
- May be upgraded to Ambushers (unless armed with missile weapons) free
- May replace great weapons with one of the following:
  - Crossbows +3 points/model
  - Handguns +3 points/model
...
#unit("SPIRITS OF THE FAY",
  profiles: (
    (name: "Fay Spirits", m: 6, ws: 4, bs: 3, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 10, points: 15),
  ),
  unit-size: "5-30",
  troop-type: "Infantry (Spirit)",
  base-size: "20x20 or 25x25",
  equipment: "Hand weapon, heavy armour, shield",
  special-rules: "Ethereal, Fear, Unstable",
  special-rules-body: [
- *Guardians of Sacred Sites:* Spirits of the Fay are not deployed with the rest of the army, but follow the entry rules for Ambushers instead.
...
#unit("SACROSANCTUM OF THE LADY",
  profiles: (
    (name: "Sacrosanctum", m: 7, ws: "-", bs: "-", s: 4, t: 5, w: 5, i: "-", a: "-", ld: "-", points: 125),
    (name: "Grail Damsel", m: "-", ws: 2, bs: 2, s: 3, t: "-", w: "-", i: 3, a: 1, ld: 7, points: ""),
    (name: "Warhorse", m: "-", ws: 3, bs: 0, s: 3, t: "-", w: "-", i: 3, a: 1, ld: 5, points: ""),
  ),
  troop-type: "Chariot (Armour Save 5+)",
  crew: "1 Grail Damsel (Human)",
  drawn-by: "2 Warhorses (Animal)",
  base-size: "50x100",
  equipment: "Hand weapon",
  special-rules: "Immunity (Psychology), Magic Resistance (2), Ward Save (4+)",
  special-rules-body: [
- *Blessed Sanctum:* A Sacrosanctum knows the three Blessings listed below. Blessings are innate Bound Spells (power level 5). For each friendly Sacrosanctum on the battlefield at the start of your magic phase, add 1 dice to your power pool.
  - *Shield of Faith: *_Shield of Faith_ is an *augment* spell that affects all friendly units with the Blessing of the Lady special rule within 12". Until the start of your next turn, the targets have their Ward save from the Blessing of the Lady increased by +1.
  - *Radiant Light: *_Radiant Light_ is a *hex* spell that affects all enemy units within 12". Until the start of your next turn, the targets suffer \-1 to their Weapon Skill and Ballistic Skill.
  - *Renewed Valour: *_Renewed Valour_ is an *augment* spell that affects all friendly units with the Blessing of the Lady special rule within 12". The target units will rally automatically (if they were fleeing) and regain the Blessing of the Lady (if they have lost it).
  ],
)
...
#unit("FIELD TREBUCHET",
  ...
  equipment: "Hand weapon",
  equipment-body: [
- *Field Trebuchet:* A Field Trebuchet uses the following profile:
...
#unit("BOMBARD",
  profiles: (
    (name: "Bombard", m: "-", ws: "-", bs: "-", s: "-", t: 7, w: "-", i: "-", a: "-", ld: "-", points: 100),
    (name: "Peasant Crew", m: 4, ws: 2, bs: 3, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 5, points: ""),
    (name: "Wall Warden", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 6, points: ""),
  ),
  ...
  equipment: "Hand weapon",
  equipment-body: [
- *Bombard:* A Bombard uses the following profile:
...
- May be mounted on one of the following:
  ...
  special-rules-body: (
    ...
    rule("The Lady’s Champion")[Louen gains a Ward Save (4+) from the Blessing of the Lady. However, if he loses the Blessing, he will immediately lose a Wound with no saves allowed.],
  ),
  notes: [
...
#unit("BOHEMUND THE BEASTSLAYER",
  ...
  profiles: (
    (name: "Bohemond the Beastslayer", m: 4, ws: 6, bs: 3, s: 4, t: 4, w: 3, i: 6, a: 4, ld: 10, points: 285),
    (name: "Warhorse", m: 8, ws: 3, bs: 0, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 5, points: ""),
  ),
  ...
  special-rules: "Blessing of the Lady, The Grail Vow, Lance Formation, Purebred Warhorse, Virtue of Heroism",
  special-rules-body: (
    rule("Beastslayer")[Bohemond has the Hatred (Beastmen, Goblins, Orcs, Skaven) special rule, and may re-roll failed rolls To Wound when fighting against such enemies.],
  ),
)
...
#unit("TANCRED II",
  ...
  profiles: (
    (name: "Tancred II", m: 4, ws: 6, bs: 3, s: 4, t: 4, w: 3, i: 6, a: 4, ld: 10, points: 235),
    (name: "Warhorse", m: 8, ws: 3, bs: 0, s: 3, t: 3, w: 1, i: 3, a: 1, ld: 5, points: ""),
  ),
  troop-type: "Cavalry (Special Character, Human)",
  mount: "Warhorse (Animal)",
...
#unit("ALBERIC OF BORDELEAUX",
  ...
  profiles: (
    (name: "Alberic of Bordeleaux", m: 4, ws: 6, bs: 3, s: 4, t: 4, w: 3, i: 6, a: 4, ld: 9, points: 175),
  ...
  magic-items: (
    rule("Trident of Manann")[Magic Weapon. Polearm. The Trident of Manann contains a Bound Spell, power level 4. This is a *magic missile* with a range of 24" that causes 2D6 Strength 3 hits.],
...
#unit("MORGIANA THE FAY",
  ...
  profiles: (
    (name: "Morgiana the Fay", m: 5, ws: 4, bs: 4, s: 3, t: 3, w: 3, i: 5, a: 1, ld: 9, points: 430),
    (name: "Silvaron (Unicorn)", m: 10, ws: 5, bs: 0, s: 4, t: 4, w: 1, i: 5, a: 2, ld: 8, points: ""),
  ),
  troop-type: "Infantry (Special Character, Human)",
  base-size: "20x20 or 25x25",
  magic: "Morgiana le Fay is a Level 4 Wizard who uses spells from the Lore of Life, Beasts, Heavens, Light or the Lady.",
  equipment: "Hand weapon",
  magic-items: (
    rule("The Girdle of Gold")[Talisman. The Girdle gives Morgiana the Fay a 4+ Ward save.],
    rule("The Chalice of Potions")[Arcane Item. At the start of your Magic phase, you may roll a D3 (using a D6). The number refers to the number of Power dice you may add to your army pool. However, if a natural 6 is rolled, the Chalice cannot be used again for the remainder of the game.],
    rule("Morgiana's Mirror")[Arcane Item. At the start of the enemy Magic phase, Morgiana the Fay may choose one enemy Wizard on the battlefield; against this Wizard, she will get a +2 Dispel bonus for the remainder of this turn.],
    rule("Toad Familiar")[Arcane Item. The Toad Familiar gives Morgiana the Fay a +1 Casting bonus.],
  ),
  options: [
- May be mounted on Silvaron +42 points
  ],
  ...
  special-rules-body: (
    ...
    rule("Supreme Blessing of the Lady")[Morgiana the Fay has the Blessing of the Lady. In addition, the Ward Save gained from the Blessing of the Lady is increased by +1 for any unit that is joined by her.],
  ),
...
#unit("LADY ELISE DUCHARD",
  ...
  profiles: (
    (name: "Élise Duchard", m: 4, ws: 3, bs: 3, s: 3, t: 3, w: 3, i: 3, a: 1, ld: 8, points: 285),
    (name: "Ariandir (Unicorn)", m: 10, ws: 5, bs: 0, s: 4, t: 4, w: 1, i: 5, a: 2, ld: 8, points: ""),
  ),
  troop-type: "Cavalry (Special Character, Human)",
  mount: "Ariandir (Forest Spirit)",
  base-size: "40x60 or 50x50",
  magic: "Élise Duchard is a Level 3 Wizard who uses spells from the Lore of Life or Heavens.",
  equipment: "Hand weapon",
  magic-items: (
    ...
    rule("The Staff of the Elements")[This item allows Élise Duchard to use the Signature Spell from either the Lore of Life or Heavens in addition to her other chosen spells.],
  ),
...
#unit("REPANSE OF LYONESSE",
  ...
  profiles: (
    (name: "Repanse de Lyonesse", m: 4, ws: 4, bs: 3, s: 3, t: 3, w: 2, i: 4, a: 2, ld: 8, points: 185),
  ),
  troop-type: "Infantry (Special Character, Human)",
  base-size: "20x20 or 25x25",
  equipment: "Heavy armour",
  magic-items: (
    rule("Sword of Lyonesse")[Magic Weapon. All magic items belonging to enemy models in base contact with Repanse lose their magical properties and will counts as mundane items of their type.],
...
#unit("TRISTAN THE TROBADOUR",
  profiles: (
    (name: "Tristan the Trobadour", m: 4, ws: 5, bs: 3, s: 4, t: 4, w: 2, i: 5, a: 3, ld: 8, points: 145),
...
- *Valorous Ballads:* Tristan knows the three songs listed below. He may choose to use one of them at the start of each round of close combat.
  ...
  - *The Grail Chorale:* The Ward save from the Blessing of the Lady is increased by +1 for Tristan and any unit he has joined this turn.
  ],
  notes: [
- Tristan the Trobadour may use a heavy lance despite having the Questing Vow.
  ],
  order: ("troop-type", "mount", "base-size", "equipment", "options", "special-rules", "notes"),
)

#unit("ODO OF OUTREMER",
  subtitle: "Hero of the Crusades",
  profiles: (
    (name: "Odo of Outremer", m: 4, ws: 6, bs: 3, s: 4, t: 4, w: 2, i: 5, a: 3, ld: 8, points: 130),
...
#unit("THE HERMIT KNIGHT OF MALMONT",
  profiles: (
    (name: "The Hermit Knight", m: 4, ws: 6, bs: 3, s: 4, t: 4, w: 2, i: 6, a: 3, ld: 9, points: 160),
  ),
  troop-type: "Infantry (Special Character, Human)",
  base-size: "20x20 or 25x25",
  equipment: "Heavy armour",
  magic-items: (
    rule("The Sword of Virtue")[Magic Weapon. Great weapon. The Sword of Virtue allows the Hermit Knight to re-roll failed rolls of 1 To Hit and to Wound. In addition, it has the Multiple Wounds (D3) special rule.],
    rule("The Flask of Sangdragon")[Enchanted Item. One use only. The Hermit Knight may use this item at the beginning of any round of Close Combat. When used, his Strength is then increased by D3 for the duration of this turn.],
  ),
...
#minitable(("Range", "Strength", "Special Rules"), ("36\"", "10", "Killing Blow"))
  ...
  special-rules-body: (
    rule("Bowmen of Bergerac")[Bertrand must be accompanied by a unit of Herrimaults chosen from the army list at a cost of 9 points per model. This unit has +1 Ballistic Skill. Little Hugo and Gui the Great are part of the unit's Command Group and must be upgraded at no additional cost. Bertrand is the unit's Leader and may never choose to leave this unit.],
    rule("Marksman")[Bertrand may re-roll failed to Hit rolls with missile weapons.],
    rule("Hugo le Petit")[Hugo le Petit is armed with a warbow instead of a longbow.],
    rule("Gui le Gros")[As long as Gui le Gros is alive, the unit he is with may re-roll failed Leadership tests.],
  ),
)
