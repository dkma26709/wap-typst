// Orcs & Goblins 3.0 - House Rules.
//
// A fork of src/orcs-goblins/3.0.typ, kept in git so a change is a diff and an
// upstream release is a three-way merge. What it changes and why is recorded in
// editions/house/orcs-goblins/3.0.toml, which is the only place that reasoning
// is written down.
...
#show: book.with(title: "Orcs & Goblins — House Rules 2026.1")
