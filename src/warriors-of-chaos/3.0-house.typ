// Warriors of Chaos 3.0 - House Rules.
//
// A fork of src/warriors-of-chaos/3.0.typ, kept in git so a change is a diff and an
// upstream release is a three-way merge. What it changes and why is recorded in
// editions/house/warriors-of-chaos/3.0.toml, which is the only place that reasoning lives.
...
#show: book.with(title: "Warriors of Chaos — House Rules 2026.1")
