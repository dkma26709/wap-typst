...
#note[_The following powers may only be taken by models with the Mark of Khorne or Daemon of Khorne._]
...
#note[_The following powers may only be taken by models with the Mark of Nurgle or Daemon of Nurgle._]
...
#note[_The following powers may only be taken by models with the Mark of Slaanesh or Daemon of Slaanesh._]
...
Once per game, at the beginning of the Close Combat phase (before challenges are issued), the bearer of the Word of Agony can choose a model in base contact. That model takes D6 Strength 4 hits which Ignores Armour saves.
...
#note[_The following powers may only be taken by models with the Mark of Tzeentch or Daemon of Tzeentch._]
...
_Gift of Chaos_ is a *hex* spell that targets all enemy units within 12". Each target suffers D6 Strength 3 Hits.
...
#namecost("CALL TO GLORY", "")
#namecost("Level 2 Cast on 7+", "")

Remains in Play. _Call to Glory_ is an *augment* spell with a range of 18". Choose one Leader model; while the spell is in effect, that model gains +1 Weapon Skill, Strength, Toughness, Wounds, Initiative, Attacks and Leadership and is treated as a Character in all aspects, though they may not leave their unit.
...
_Fold Reality_ is an *augment* spell with a range of 18". The target unit instantly recovers D6+1 Wounds' worth of models slain earlier in the battle, just like a summoning spell. However, if a 1 is rolled, the target suffers D6+1 Wounds with no saves allowed instead.
...
Remains in play. _Daemonfire Vortex_ is a *magical vortex* that uses the small round template. Any model touched by the template at any point during its move suffer a Strength D6+1 hit (roll once for each unit and apply the result to all models in that unit) with the Flaming Attacks special rule.
...
_Rot, Glorious Rot_ is a *hex* spell that targets all enemy units within 18". Each target suffers D6 Strength 3 Hits with the Ignores Armour Saves special rule.
]
...
Remains in play. _Hysterical Frenzy_ is an *augment/hex* spell with a range of 24". While the spell is in effect, the target gains the Frenzy special rule (which is not lost if the unit is defeated in close combat) and suffer D6 Strength 3 hits at the end of each of the caster’s Magic phases.
...
Close combat attacks made with the Hellfire Sword have the Flaming Attacks and Ignores Armour Saves special rules. After all close combat blows have been struck, roll a D6 for every foe slain by the Hellfire Sword – on the roll of a 6, the slain foe’s body explodes, inflicting an additional D6 Strength 4 hits on the enemy unit with the Flaming Attacks special rule. Unsaved Wounds inflicted in this way count towards the combat result. At the end of each of the wielder’s turns, roll a D6; on the roll of a 1, they suffer one Wound with the Ignores Armour Saves special rule.

#namecost("VAMPIRIC AXE", "30 points")

Great weapon. For each unsaved Wound the wielder inflicts with this weapon, they regain +1 Wound up to their starting value.
...
#entry("MAGIC ARMOUR")
#namecost("VOID ARMOUR", "50 points")

Model on foot only. Heavy armour. The wearer gains the Ethereal special rule. However, they may take no other Magic Items.

#namecost("ARMOUR OF MORRSLIEB", "45 points")

Heavy armour. The Armour of Morrslieb gives the wearer a 4+ Ward Save against non-Magical Attacks.

#namecost("CRIMSON ARMOUR OF DARGAN", "35 points")
...
This item gives the wearer a 6+ armour save. All enemy units within 6" of the wearer of this helmet suffer \-1 to their Leadership.

#namecost("IDOLATROUS PLACKART", "35 points")

Heavy armour. The wearer of this armour have a 5+ Ward save which gets reduced to a 6+ Ward save against Magical Attacks.

#namecost("ARMOUR OF THE DAMNED", "30 points")

Heavy armour. Enemy models must re-roll successful To Hit rolls in close combat against the wearer of this armour.

#namecost("NULL PLATE", "30 points")

Heavy armour. All close combat and missile attacks targeting the wearer of this armour suffer \-1 To Hit.

#namecost("BRONZE ARMOUR OF ZHRAKK", "25 points")
...
#namecost("SKINHIDDEN PLATE", "25 points")
...
This item gives the wearer a 6+ armour save. All enemy Wizards within 12" of the wearer of these gauntlets suffer \-2 to their casting results. In addition, the wearer gains +1 To Wound against Wizards in close combat.
...
Wizard only. This item gives the wearer a 6+ armour save. Whenever the wearer successfully dispels an enemy spell (except Summoning or Innate Bound Spells), they may attempt to cast that spell themselves (limited by their Wizard level as normal) in their next Magic phase.
...
#namecost("ROD OF TORMENT", "35 points")

Bound Spell, Power Level 5. The Rod of Torment contains a *magic missile* with a range of 18" and causes 2D6 Strength 3 hits.
...
Bound Spell, power level 4. The Banner of Wrath contains a *magic missile* with a range of 24". If cast, it causes D6 Strength 4 hits with the Lightning Attacks special rule.
...
#namecost("BLADE OF BLOOD", "30 points")
...
#entry("MAGIC ARMOUR")
#namecost("SPELLEATER SHIELD", "40 points")
...
The wearer of this item gains a 2+ Ward save against spells.

#entry("ENCHANTED ITEMS")
#namecost("MARK OF THE DESTROYER", "50 points")

The wielder doubles their amount of Attacks (to a maximum of 10). However, if the wearer fails to kill at least one model each close combat phase in which they are part of, treat this as having rolled the Damned by Chaos result on the Eye of the Gods chart.
...
#namecost("THE FOETID SHROUD", "25 points")

All close combat attacks targeting the wearer of this item suffer \-1 To Hit.

#entry("ARCANE ITEMS")
#namecost("ROD OF CORRUPTION", "30 points")

Bound Spell, Power Level 3. The Rod of Corruption contains a *direct damage* spell with a range of 24". The target unit suffers D6 Strength 2 Hits with the Ignores Armour Saves special rule.
...
#entry("TALISMANS")
#namecost("JEWEL OF DENIAL", "35 points")

The bearer of this item gains a 5+ Ward save. In addition, each time they make a successful Ward save in close combat, they gain +1 combat resolution bonus.
...
Bound Spell, Power Level 3. The Sceptre of Domination contains the _Pavane of Slaanesh_ spell from the Lore of Slaanesh.
...
#entry("TALISMANS")
#namecost("GOLDEN EYE OF TZEENTCH", "30 points")

The bearer gains a 3+ Ward save against all missile attacks.
...
#namecost("MIRROR OF KNOWLEDGE", "15 points")
...
#field("MAGIC", "A Chaos Sorcerer Lord is a Level 3 Wizard who uses spells from the Lore of Fire, Metal, Shadow, Death or Chaos. A Chaos Sorcerer Lord with the Mark of Tzeentch, Nurgle or Slaanesh must use the Lore of Tzeentch, Nurgle, or Slaanesh, respectively.")
#field("OPTIONS", "")
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "A Daemon Prince that is a Wizard uses spells from the Lore of Fire, Metal, Shadow, Death or Chaos. A Daemon Prince with the Mark of Tzeentch, Nurgle or Slaanesh must use the Lore of Tzeentch, Nurgle, or Slaanesh, respectively.")
#field("OPTIONS", "")
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "A Chaos Sorcerer is a Level 1 Wizard who uses spells from the Lore of Fire, Metal, Shadow, Death or Chaos.")
...
#entry("CHAOS WARRIORS", first: true)
#profile(
...
#field("SPECIAL RULES", "Frenzy, Immunity (Psychology), Random Attacks (D3).")
...
- *Forsaken of Khorne:* Forsaken of Khorne have the Hatred special rule.
- *Forsaken of Nurgle:* Forsaken of Nurgle have the Fear special rule.
- *Forsaken of Slaanesh:* Forsaken of Slaanesh have the Swiftstride special rule.
- *Forsaken of Tzeentch:* Forsaken of Tzeentch have the Ward save (6+) special rule.
...
#field("UNIT SIZE", "5+")
#field("TROOP TYPE", "War Beast (Chaos Beast)")
...
- *Chosen of the Dark Gods:* Chosen have the Eye of the Gods special rule. If the result rolled is Damned by Chaos or Dark Apotheosis, that result is immediately applied to the unit’s Chosen Leader (if the unit does not contain a Chosen Leader, the result is instead treated as a ‘The Eye Opens’ result), otherwise the result is applied to every Chosen model in the unit.
...
#field("UNIT SIZE", "5+")
#field("TROOP TYPE", "Cavalry (Human)")
#field("MOUNT", "Chaos Steed (Animal)")
#field("BASE SIZE", "25x50 or 30x60")
...
#field("TROOP TYPE", "Chariot (Armour Save 6+)")
#field("CREW", "2 Charioteers (Human)")
#field("DRAWN BY", "2 Chaos Steed (Animal)")
#field("BASE SIZE", "50x100 or 60x100")
...
#field("TROOP TYPE", "Chariot (Armour Save 6+)")
#field("CREW", "2 Charioteers (Human)")
#field("DRAWN BY", "1 Gorebeast (Chaos Beast)")
#field("BASE SIZE", "50x100 or 60x100")
#field("EQUIPMENT", "Polearm, heavy armour, scythes, barding")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Scouts, Skirmishers, Will of Chaos")
...
- *Skin Wolves of Khorne:* The model gains the Mighty Blow (1) special rule when charging.
- *Skin Wolves of Nurgle:* The model gains the Poisoned Attacks special rule.
- *Skin Wolves of Slaanesh:* The model gains gain the Always Strikes First special rule.
- *Skin Wolves of Tzeentch:* The model gains the Regeneration (6+) special rule.
...
#field("SPECIAL RULES", "Loner, Natural Armour (+6), Regeneration (4+), Stupidity")
...
#field("SPECIAL RULES", "Random Attacks (D6+1), Random Movement (3D6), Unbreakable")
#field("UPGRADES", "")
...
#field("EQUIPMENT", "Light lances, heavy armour, shield, barding")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Chaos Armour, Daemonic (Daemonic Mount), Devastating Charge, Will of Chaos")
...
#field("DRAWN BY", "2 Shrine Bearers (Chaos Beast)")
#field("BASE SIZE", "50x100 or 60x100")
#field("EQUIPMENT", "Hand weapon, light armour")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Fear, Random Attacks (D3+1) (Shrine Bearers only), Ward Save (5+), Will of Chaos")
...
#entry("GIANT SPINED CHAOS BEAST")
#profile(
...
- *Beast of Tzeentch:* A Beast of Tzeentch has a Ward save (6+).

#entry("GIANT CHAOS SPAWN")
#profile(
...
#field("TROOP TYPE", "Monster (Dragon)")
#field("BASE SIZE", "50x100 or 60x100")
#field("SPECIAL RULES", "Fly (7), Magical Attacks, Natural Armour (3+), Regeneration (6+)")
...
#field("EQUIPMENT", "Hand weapon, light armour (Handlers only)")
#field("OPTIONS", "")
...
- *Giant of Tzeentch:* A Giant of Tzeentch has a Ward save (6+).

#entry("CHAOS WAR MAMMOTH")
#profile(
...
#field("TROOP TYPE", "Monster (Mammoth)")
...
#field("SPECIAL RULES", "Daemon of Nurgle, Poisoned Attacks, Regeneration (5+)")
]
...
#field("UNIT SIZE", "5+")
#field("TROOP TYPE", "Large Infantry (Human)")
...
#field("TROOP TYPE", "Large Infantry (Human)")
#field("BASE SIZE", "30x30 or 40x40")
#field("EQUIPMENT", "Wraihflails, medium armour")
...
#field("BASE SIZE", "50x75")
#field("EQUIPMENT", "Light lance, heavy armour, shield")
#field("OPTIONS", "")
...
#field("MOUNT", "Rot Beast of Nurgle (Chaos Beast)")
#field("BASE SIZE", "50x75")
...
- *Unspeakable Foulness:* This is a Breath Weapon attack. Any models that are hit must pass a Toughness test at a \-1 penalty or suffer a wound with the Multiple Wounds (D3) and Ignores Armour saves special rules.
...
#field("MAGIC", "A unit of Fatemasters is a Level 1 Wizard that can use spells from the Lore of Tzeentch.")
#field("OPTIONS", "")
...
- *The Eye of Sheerian:* Talisman. The Eye of Sheerian grants Archaon a Ward save (3+).
...
- *Chosen of the Gods:* As the Chosen of Gods, Archaon has the following bonuses: Immunity (Psychology), Immunity (Poisoned Attacks), Magic Resistance (2), and he may re-roll any channelling dice rolls of a 1. Re- roll any Eye of the Gods rolls of 2 and 12.
...
- *Living Damnation:* At the start of each of his turns, Mordrek must roll a D6 for his Weapon Skill and Attacks characteristics, as well a D3 for his Strength and Toughness and characteristics, and add the result to his profile.
...
#field("MOUNT", "Thanatorg (Chaos Beast)")
#field("BASE SIZE", "50x100 or 60x100")
#field("EQUIPMENT", "Heavy armour, barding")
#field("MAGIC ITEMS", "")
...
#field("MAGIC", "Sayl is a Level 3 Wizard who uses spells from the Lore of the Heavens or Lore of Shadow.")
#field("MAGIC ITEMS", "")

- *The Viperous Staff:* Magic Weapon. All attacks with the Viperous Staff have the Killing Blow special rule. In addition, it grants the wielder a 5+ Ward save.
...
- *Traitor's Mist:* Innate Bound Spell, power level 4. _Traitor's Mist_ is an *augment* spell that Sayl can cast upon himself. Sayl may immediately make a move using the Fly (10) special rule as if it were the Remaining Moves sub-phase. In addition, any model (friend or foe) in base contact at the start of the move suffers an automatic Strength 3 hit which Ignores Armour saves.
...
- *Infernal Runeshield:* Shield. This shield gives Marakarr a 5+ Ward save. In addition, whenever she makes a successful Parry save, the model that struck the blow suffer one Wound which Ignores Armour Saves.
...
#field("SPECIAL RULES", "Immunity (Lightning Attacks, Psychology), Impact Hits (D6), Natural Armour (4+), Storm")
...
#entry("WULFRIK THE WANDERER", first: true)
...
- *Gift of Tongues:* When Wulfrik the Wanderer issues a challenge, your opponent cannot choose to refuse it. Furthermore, Wulfrik nominates which enemy character will accept the challenge.
- *Hunter of Champions:* As soon as Wulfrik the Wanderer is placed on the tabletop, nominate one enemy character in your opponent's army – this is the champion Wulfrik has journeyed to challenge. Against the chosen character, Wulfrik always Hit and Wound on a 2+ and gets the Killing Blow special rule.
...
#field("SPECIAL RULES", "Eye of the Gods, Natural Armour (6+)")

- *Copious Vomit:* Throgg has a Strength 5 Breath Weapon with the Ignores Armour saves special rule.
- *Lord of the Monstrous Horde:* If your army includes Throgg, units of Chaos Trolls count as Core choices instead of Special choices, and at least one unit must be included.
- *Mutant Regeneration:* Throgg has the Regeneration (4+) special rule. In addition, if Throgg Regenerates two or more Wounds in the same phase, he rolls on the Eye of the Gods table at the end of that phase.
...
#field("SPECIAL RULES", "Chaos Armour, Eye of the Gods, Fear, Fly (10), Mark of Khorne, Ward save (5+), Will of Chaos")

- *Consort of the Blood God:* If Valkia the Bloody is required to roll on the Eye of the Gods table, do not roll any dice. Instead, she is always counted as having rolled the Slaughterer's Strength reward.
...
- *Wrath of Khorne:* Arbaal must always issue and accept challenges. In addition, if Arbaal flees for any reason, he will be turned into Chaos Spawn of Khorne. Make the flee move with Arbaal as normal, and then replace the model with a Chaos Spawn of Khorne following the rules for Damned by Chaos on the Eye of the Gods table.
...
#field("TROOP TYPE", "Large Infantry (Special Character, Human)")
#field("BASE SIZE", "30x30 or 40x40")
#field("EQUIPMENT", "Light armour")
#field("MAGIC ITEMS", "")
...
- *The Black Cleaver:* Magic Weapon. Tyrant only. Great weapon. Any model that suffers a wound from the weapon and survives must take a Toughness test or suffer a permanent reduction of \-1 to their Toughness score.

#field("OPTIONS", "")

- May be mounted on Bubebolos +375 points

#field("SPECIAL RULES", "Chaos Armour, Eye of the Gods, Mark of Nurgle (included in profile), Unbreakable")
...
#entry("ORGHOTTS DAEMONSPEW")
#namecost("Master of the Pox Maggoths", "")
#profile(
...
#field("TROOP TYPE", "Monster (Special Character, Human)")
#field("MOUNT", "Whippermaw (Chaos Beast)")
#field("BASE SIZE", "60x100")
#field("EQUIPMENT", "Heavy armour")
#field("MAGIC ITEMS", "")

- *The Rotaxes:* Magic Weapon. Two hand weapons. Close combat attacks made by the wielder have +2 Strength and the Poisoned Attacks special rule.

#field("SPECIAL RULES", "Chaos Armour, Eye of the Gods, Mark of Nurgle (included in profile), Ward Save (6+), Will")
...
#entry("BLOAB ROTSPAWNED")
#namecost("Harbinger of Fecundity", "")
#profile(
...
#field("TROOP TYPE", "Monster (Special Character, Human)")
#field("MOUNT", "Bilespurter (Chaos Beast)")
#field("BASE SIZE", "60x100")
#field("EQUIPMENT", "Great weapon, medium armour")
...
#entry("MORBIDEX TWICEBORN")
#namecost("Enemy of Sterility", "")
#profile(
...
#field("TROOP TYPE", "Monster (Special Character, Human)")
#field("MOUNT", "Tripletongue (Chaos Beast)")
#field("BASE SIZE", "60x100")
#field("EQUIPMENT", "Great weapon, medium armour")
#field("MUTATIONS & POWERS", "Nurgle's Rot")
#field("SPECIAL RULES", "Chaos Armour, Eye of the Gods, Mark of Nurgle (included in profile), Regeneration (4+), Will of Chaos")
...
#field("MUTATIONS & POWERS", "Allure of Slaanesh, Diabolic Splendour")
#field("SPECIAL RULES", "Chaos Armour, Eye of the Gods, Mark of Slaanesh, Strider, Stupidity")

- *Favoured Son:* If Sigvald the Magnificent is required to roll on the Eye of the Gods table, do not roll any dice. Instead, he is always counted as having rolled the Dark Fury reward.
...
#field("MAGIC", "Glutos Orscollion is a level 4 Wizard who uses spells from the Lore of Slaanesh.")
#field("MAGIC ITEMS", "")

- *The Leerstave of Loth'shar:* Arcane Item. The Leerstave gives Glutos a +1 casting and dispelling bonus.

#field("SPECIAL RULES", "Eye of the Gods, Mark of Slaanesh, Ward Save (5+).")
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Heavy armour")
#field("MAGIC", "Vilitch the Curseling is a Level 4 Wizard who uses spells from the Lore of Tzeentch.")
#field("MAGIC ITEMS", "")
...
#field("MUTATIONS & POWERS", "Conjoined Homunculus")
...
#field("TROOP TYPE", "Monster (Special Character, Dragon)")
#field("BASE SIZE", "50x50, 50x100, 60x100")
#field("MAGIC", "Galrauch is a Level 4 Wizard who uses spells from the Lore of Tzeentch.")
#field("SPECIAL RULES", "Dark Fire of Chaos (see Chaos Dragons), Fly (7), Mark of Tzeentch, Natural Armour (3+), Ward Save (6+)")
...
#entry("SCYLA ANFINGRIMM", first: true)
...
#field("TROOP TYPE", "Monstrous Beast (Special Character, Chaos Beast)")
#field("BASE SIZE", "40x40 or 50x50")
#field("MAGIC ITEMS", "")

- *Brass Collar of Khorne:* Talisman. The Brass Collar of Khorne bestows Scyla Anfingrimm with a 6+ Ward save and the Magic Resistance (3) special rule.
...
#field("TROOP TYPE", "Monstrous Cavalry (Special Character, Human)")
#field("MOUNT", "Rotbeast of Nurgle (Chaos Beast)")
#field("BASE SIZE", "50x75")
#field("EQUIPMENT", "Heavy armour")
#field("MAGIC ITEMS", "")
...
#field("SPECIAL RULES", "of the Gods, Mark of Nurgle (included in profile), Poisoned Attacks, Regeneration (4+), Will")
...
#field("SPECIAL RULES", "Chaos Armour, Always Strikes First, Eye of the Gods, Mark of Slaanesh, Poisoned Attacks.")
