...
Each time a Wizard successfully casts an *augment* or *conveyance* spell from the Lore of Nehekhara, the target of the spell immediately recovers a number of Wounds' worth of models, just like a summoning spell. Core Units (except Chariots) recover D6+1 Wounds. Special Units, Chariots and Monstrous Cavalry recover D3 Wounds. Remaining Rare Units recover 1 Wound.
...
_Merneptah's Scroll of the Scarab Song_ is a *direct damage* spell. Place the large round template anywhere within 24" of the Wizard – it then scatters D6". All models under the template suffer a Strength 1 hit with the Poisoned Attacks special rule.
...
_Neru's Incantation of Protection_ is an *augment* spell with a range of 18". The target unit gains a 5+ Ward save until the start of the caster's next Magic phase.
...
#namecost("CROOK AND FLAIL OF RADIANCE", "50 points")

Two hand weapons. These weapons gives the wielder the Always Strikes First special rule and +1 Combat Resolution bonus.

#namecost("DESTROYER OF ETERNITIES", "40 points")
...
No Ward saves can be taken against Wounds caused by this item. In addition, any model that suffers an unsaved Wound from it must pass a Toughness test or suffer an additional Wound with no saves allowed. They must keep taking Toughness tests until they pass or are removed as a casualty.
...
The wielder of this weapon gains the Killing Blow special rule. When fighting in a challenge, their Killing Blow takes effect on a 5+ rather than a 6.

#namecost("STAFF OF AEONS", "10 points")

Wizard only. If the wielder of this item successfully Hits an enemy unit one or more times in close combat, that unit suffers \-1 to their armour saves for the duration of the game.
...
#namecost("ARMOUR OF THE AGES", "30 points")

Light armour. When the wearer of this armour is reduced to their last Wound, they gain a 3+ Ward save. This has no effect if they suffer their last Wound as a result of an attack that causes Multiple Wounds.
...
This item gives the bearer a 6+ armour. In addition, they gain +1 Strength and Toughness. However, at the start of each of your turns, they must pass a Toughness test or suffer one Wound with no saves allowed.

#namecost("SHIELD OF PTRA", "25 points")

Shield. The bearer of this shield gains the Parry (6+) special rule even while mounted. If they make a successful Parry save, all models in base contact with them suffer \-1 To Hit for the remainder of the turn, or the next turn if they have already attacked this turn.

#namecost("WARDING SPLINT", "25 points")

Wizard only. Light armour. This armour gives the wearer a 5+ Ward save in close combat. This armour may be taken even though Wizards may not normally wear armour.

#namecost("ROYAL MANTLE", "15 points")

This item gives the bearer a 6+ armour and the Inspiring Presence (6) special rule.

#entry("TALISMANS")
#namecost("GOLDEN ANKHRA", "55 points")

The Ankhra gives the bearer a 4+ Ward save. In addition, they may re-roll 1's when taking Ward saves.
...
#namecost("GOLDEN EYE OF RAH-NUTT", "30 points")

Model on Chariot only. The Golden Eye gives the bearer a 3+ Ward save against missile attacks.
...
The bearer of the Relic of the Desert Sun gains a 6+ Ward save and Immunity (Flaming Attacks).

#entry("ARCANE ITEMS")
#namecost("PHAZERAKT'S KANOPI", "35 points")

Bound Spell (power level 6). This item contains an *augment/summoning* spell with a range of 12". You can choose to either summon 2D6+3 Skeleton Warriors to an existing unit (this may take them over their starting value) or create a new unit.

#namecost("STAFF OF OSIRIS", "35 points")

Bound Spell (power level 5). This item contains a *magic missile* with a range of 24". It inflicts a single Strength 6 hit with the Armour Piercing (1) and Multiple Wounds (D3) special rules that penetrates ranks in the same manner as a shot from a Bolt Thrower.
...
The wielder of the Staff of Awakening may re-roll the amount of Wounds recovered from The Restless Dead.

#namecost("CURSE-WEAVER WAND", "20 points")

The Curse-weaver Wand gives the bearer a +2 casting bonus when casting a *hex* spells.

#namecost("STAFF OF MASTERY", "20 points")

The Staff of Mastery gives the bearer a +1 casting bonus when using the Lore of Light.

#namecost("ENKHIL'S KANOPI", "15 points")
...
One use only. This item may be used after rolling the Power dice to cast a spell. When used, add a +D3 casting bonus to the roll.
...
Model on Chariot only. The Chariot of Fire causes 2D6 impacts hits with the Flaming Attacks and Magical Attacks special rules.

#namecost("ICON OF RULERSHIP", "20 points")
...
The bearer of this item gains +1 Leadership and the Cold-Blooded special rule.
...
#namecost("ICON OF THE SACRED EYE", "40 points")
...
#namecost("TAPESTRY OF CONQUERED LANDS", "40 points")
...
The unit carrying this standard gains the Hatred (Characters) and Terror special rules.
...
Bound Spell (power level 5). This banner contains an *augment* spell that targets the bearer's unit. If successfully cast, the bearer's unit immediately recovers a number of Wounds' worth of models, as described in the Restless Dead.

= LORDS

#entry("TOMB KING", first: true)
#profile(
...
#field("SPECIAL RULES", "Curse of the Necropolis, Flammable, My Will Be Done, Undead")

#entry("LICHE HIGH PRIEST")
#profile(
...
#field("MAGIC", "A Liche High Priest is a Level 3 Wizard who uses spells from the Lore of Light, Death or Nehekhara.")
#field("OPTIONS", "")
...
#field("BASE SIZE", "20x20 or 25x25")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "A Liche High Priest is a Level 1 Wizard who uses spells from the Lore of Light, Death or Nehekhara.")
#field("OPTIONS", "")
...
#field("DRAWN BY", "2 Skeletal Steeds (Undead)")
#field("BASE SIZE", "50x100")
#field("EQUIPMENT", "Light lance, bow, javelins")
#field("OPTIONS", "")
...
#field("BASE SIZE", "20x20 or 25x25")
#field("EQUIPMENT", "Hand weapon")
#field("SPECIAL RULES", "Curse of the Necropolis, Flammable, Undead")
]
...
- *Aspect of Djaf, God of Death:* The unit gains the Killing Blow special rule.
- *Aspect of Geheb, God of Earth and Giver of Strength:* The unit gains the Mighty Blow (1) special rule.
- *Aspect of Phakth, God of the Sky and Bringer of Justice:* The unit gains +1 Movement.
...
#compact-entry("TOMB SCORPION")[
#profile(
  (name: "Tomb Scorpion", m: 7, ws: 4, bs: 0, s: 5, t: 5, w: 3, i: 3, a: 4, ld: 8, points: 60),
)
#field("TROOP TYPE", "Monstrous Beast (Undead)")
#field("BASE SIZE", "50x50 or 75x50")
#field("SPECIAL RULES", "Entombed Beneath the Sands, Killing Blow, Magic Resistance (1), Natural Armour (5+), Poisoned Attacks, Undead")
]
...
#field("SPECIAL RULES", "Killing Blow, Magical Attacks, Natural Armour (6+), Scouts, Undead")
...
- *Screaming Skulls:* All shooting attacks made by a Screaming Skull Catapult are magical and have the Flaming Attacks special rule. In addition, any unit that suffers one or more casualties from a shooting attack by a Screaming Skull Catapult must take a Panic test as if it had taken 25% casualties.

#field("UPGRADES", "")

- *Skulls of the Foe:* This upgrade adds an additional effect to the catapult's Screaming Skulls. If a target unit takes a Panic test as a result of being hit by the Skulls of the Foe, then they must take the test with a \-1 penalty to their Leadership.
...
#field("SPECIAL RULES", "Killing Blow (Casket Guard only), Magical Attacks (Casket Guard only), Undead, Ward Save")
...
#field("SPECIAL RULES", "Fly (7), Heroic Killing Blow, Undead")
#field("UPGRADES", "")
...
- *Icon of Ptra:* Arcane Item. Bound Spell (power level 3). An Icon of Ptra contains the spell _Shem's Burning Gaze_ from the Lore of Light.
- *Scales of Usirian:* Arcane Item. Bound Spell (power level 4). The Scales of Usirian contain the spell _Spirit Leech_ from the Lore of Death).
...
#field("TROOP TYPE", "Monster (Undead)")
#field("BASE SIZE", "100x150")
#field("SPECIAL RULES", "Fly (7), Impact Hits (D6), Natural Armour (5+), Undead")
...
#field("TROOP TYPE", "Chariot (Special Character, Undead)")
#field("BASE SIZE", "100x100")
#field("DRAWN BY", "4 Skeletal Steeds (Undead)")
#field("EQUIPMENT", "Scythes")
#field("MAGIC", "Settra the Imperishable is a Level 2 Wizard who uses spells from Lore of Nehekhara.")
#field("MAGIC ITEMS", "")
...
- *Scarab Brooch of Usirian:* Talisman. The Scarab Brooch of Usirian grants Settra the Ward Save (4+) and the Magic Resistance (1) special rules.
...
#field("SPECIAL RULES", "Flammable, My Will Be Done, Undead")
...
- *Settra the Great:* If you take Settra the Imperishable, he must be your Army General. Settra has the Inspiring Presence (6) special rule in addition to his normal Inspiring Presence.
...
- *Venom Staff:* Arcane Item. Bound Spell (power level 5). The Venom Staff contains a *magic missile* with a range of 24". If successfully cast, the target takes 2D6 Strength 3 hits with the Poisoned Attacks special rule.
...
#field("SPECIAL RULES", "Always Strikes First, Curse of the Necropolis, Flammable, Hatred (Vampire Counts), My")
...
#field("BASE SIZE", "20x20 or 25x25")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Khatep is a Level 4 Wizard who uses spells from Lore of Nehekhara.")
#field("MAGIC ITEMS", "")
...
#field("SPECIAL RULES", "Loremaster (Lore of Nehekhara), Undead")
...
#field("MAGIC", "Arkhan the Black is a Level 4 Wizard who uses spells from Lore of Death and Nehekhara. He may choose")

spells from both Lores in any combination as he wishes.

#field("MAGIC ITEMS", "")

- *Tomb Blade of Arkhan:* Magic Weapon. For every unsaved Wound caused by this blade to an enemy in close combat, Arkhan's unit immediately recovers a Wound for each one inflicted, as described in Resurrecting Fallen Warriors.
- *Liber Mortis:* Arcane Item. Whilst Arkhan the Black has the Liber Mortis he gains +1 to cast, +1 to dispel and one additional spell. If the Liber Mortis is ever destroyed, Arkhan the Black immediately loses a randomly determined spell.
- *Staff of Nagash:* Arcane Item. At the end of the opponent's Magic phase, you can store up to three unused dispel dice from your pool in the Staff of Nagash. At the beginning of your next Magic phase, add these dice to your power dice pool. If Arkhan the Black is removed as a casualty before your next Magic phase, these power dice are lost.
...
#field("BASE SIZE", "50x50")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Sehenesmet is a Level 2 Wizard who uses spells from Lore of Nehekhara.")
#field("MAGIC ITEMS", "")
...
#field("SPECIAL RULES", "Hatred, Magic Resistance (2), Undead")

- *Master Stone Shaper:* Sehenesmet follows the normal rules for Stone Shaper, but grants Regeneration (5+) rather than Regeneration (6+).
...
#entry("PRINCE TUTANKHANUT", first: true)
...
#field("TROOP TYPE", "Infantry (Special Character, Undead)")
#field("BASE SIZE", "20x20 or 25x25")
#field("EQUIPMENT", "Hand weapon, bow, heavy armour")
#field("OPTIONS", "")

- May be mounted on a Skeleton Chariot +48 points
- May take Magic Items up to a total of 50 points

#field("SPECIAL RULES", "Arrows of Asaph, Curse of the Necropolis, Flammable, My Will Be Done, Undead")
...
#field("BASE SIZE", "20x20 or 25x25")
#field("EQUIPMENT", "Hand weapon, light armour")
#field("SPECIAL RULES", "Entombed Beneath the Sands, Fly (10), Loner, Regeneration (4+), Strider, Terror, Undead")
...
#field("SPECIAL RULES", "Flammable, Killing Blow, Magical Attacks, Sworn Bodyguard (see Tomb Herald), Undead")
...
- *Settra's Champion:* If able to, Nekaph must always issue and accept challenges. When fighting in a challenge, Nekaph gains a 5+ Ward save and the Killing Blow special rule.
