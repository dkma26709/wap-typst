...
#magic-weapon("SHOCK-PROD*", 25)[Clan Moulder only. Polearm. A Shock-Prod gives the wielder the Lightning Attacks special rule.]
...
#magic-weapon("SNAP-SNAP SNAREPOLE*", 20)[Clan Moulder only. Polearm. One enemy model in base contact of your choice suffer a \-1 penalty to their Attacks.]

#magic-weapon("THINGS-CATCHER*", 20)[Clan Moulder only. Polearm. A Things-catcher gives the wielder the Killing Blow special rule.]
...
#magic-weapon("WEEPING BLADES*", 15)[Clan Eshin only. Two hand weapons. All attacks made by Weeping Blades have the Armour Piercing (1), Magical Attacks and Multiple Wounds (D3) special rules.]

#magic-weapon("WARPSTONE STARS*", 15)[#minitable(("Range", "Strength", "Special Rules"), ("6/9\"", "As user", "Armour Piercing (1), Magical Attacks, Multiple Shots (2), Multiple Wounds (D3), Quick Shot"))]
...
#magic-armour("FOULHIDE", 30)[Medium armour. This armour gives the wearer the Regeneration (5+) special rule.]
...
#talisman("WARPSCALE PENDANT*", 10)[The Warpscale Pendant gives the bearer the Immunity (Flaming Attacks, Lightning Attacks) and Magic Resistance (2) special rules. However, at the beginning of the game, the bearer must pass a Toughness test or suffer a Wound with no saves allowed.]
]

#magic-item-section("arcane")[
#arcane-item("WARPSCROLL", 25)[Charm. One use only. Bound spell (Level 3, cast on 9+). The Warpscroll contains a *direct damage* spell with a range of 24". All models in the target unit suffer a Strength 3 Hit. If the unit suffers any casualties from the spell, they must also take a Panic test.]

#arcane-item("WARPSTORM SCROLL", 25)[Charm. Bound Spell (Level 2, cast on 7+). One use only. The Warpstorm Scroll contains a *direct damage* spell that targets all units with the Fly special rule within 24". The target units suffer D6 Strength 6 Hits with the Lightning Attacks special rule.]

#arcane-item("ESOTERIC WARP RESONATOR", 20)[Clan Skryre only. Relic. The bearer of this item adds a free Power dice to their casting attempt whenever they attempt to cast the _Warp Lightning_ spell from the Lore of Ruin.]

#arcane-item("STAFF OF RIGHTFUL SUPREMACY", 20)[Staff. All enemy Wizards within 12" of the bearer of this item suffer a \-1 casting penalty. In addition, if the bearer's dispel roll result is 13, the spell is automatically dispelled.]

#arcane-item("EYE OF THE HORNED RAT", 15)[Relic. The Eye of the Horned Rat may be used at the start of your Magic Phase. Roll a D6, on a 2+, add one dice to your power dice pool. On 1, remove one dice from your power dice pool.]

#arcane-item("SCRYING STONE", 10)[Charm. One use only. The bearer of the Scrying Stone gains a Magical Ward (2+) against their first wounding Hit suffered. However, if this Wound is saved the model gains the Stupidity rule for the remainder of the game.]

#arcane-item("WARPSTONE TOKEN*", 10)[Charm. One use only. Multiples of this item may be taken by a single model. The model can choose to use one or more tokens whenever they cast a spell. For each token consumed, they add add an additional power dice to their casting attempt. This allows them to roll more dice than is normally allowed by their level. A spell may be cast entirely with Warpstone Tokens if you wish. However, for every Warpstone generated dice that rolls a 1 the Wizard suffers a Wound with no saves allowed.]
]
...
#enchanted-item("THE CUBE OF MISTS", 30)[Clan Eshin only. One use only. This item can be used at the start of any round of close combat. Once used, no enemy units in base contact with the bearer can make Supporting Attacks this round. In addition, all enemy models in the unit suffer \-1 To Hit.]

#enchanted-item("DOOMROCKET", 30)[Clan Skryre only. One use only. A Doomrocket is a rocket launcher that uses the small template with the following profile:
...
#enchanted-item("FARSKITTER CLOAK", 15)[Clan Eshin only. Bound spell (Level 1, cast on 5+). This item contains a *conveyance* spell that targets the bearer. The bearer is immediately picked up and may be moved to any position on the battlefield within 24" of their original position, just like a summoning spell.]

#enchanted-item("WARPSTONE INNARDS", 15)[Mounted Clan Moulder model only. The bearer's mount gains +1 Strength and the Frenzy special rule. However, it must take a Toughness test at the start of each of your turns or suffer a Wound with no saves allowed.]
...
#magic-standard("STORM BANNER", 50)[One use only. This standard can be activated at the beginning of any player's turn. Within 24" of this standard, no model may use the Fly special rule and units are at \-2 to be Hit with non-magical missile attacks. All non-magical missile attacks that do not use Ballistics Skill to hit need to roll a 4+ on a D6 before they can attempt to fire if they are within 24" of the banner. Roll a D6 at the beginning of each following player turn – the effects of the banner will end on a D6 roll of 4+.]
