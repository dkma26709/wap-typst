...
#para(((emph: "", text: "Each breed of synapse creature colours the will it carries: prey-hate from a Tyrant, patience from the Warriors, the scent of the hunt from a Broodlord. At the start of each friendly turn, each Tyranid unit that is not itself a Synapse creature and is within range of one or more friendly Synapse creatures becomes attuned to exactly one of them, chosen by the controlling player. Until the start of the next friendly turn, the unit gains the benefit listed below for its anchor. Some anchors give no gift but draw on the broods bound to them instead — these are marked Communion, and are empowered while at least one unit is attuned to them. A unit can never benefit from more than one attunement at a time, and the Capillary Cluster grants no attunement — it is a beacon, not a mind."),))
#items(((runs: ((emph: "", text: "Hive Tyrant: The attuned unit has the Hatred special rule."),), sub: ()), (runs: ((emph: "", text: "Neurotyrant: Enemy units in base contact with the attuned unit suffer a -1 penalty to their Leadership."),), sub: ()), (runs: ((emph: "", text: "Tyranid Prime: The attuned unit may re-roll To Hit rolls of 1 in close combat."),), sub: ()), (runs: ((emph: "", text: "Tyranid Warriors: The attuned unit takes Hive Mind Instability tests as if it were Steadfast, on its unmodified Leadership."),), sub: ()), (runs: ((emph: "", text: "Broodlord (Communion): While at least one unit is attuned to the Broodlord, enemy models take the Leadership test against his Hypnotic Gaze with a -1 penalty."),), sub: ()), (runs: ((emph: "", text: "Zoanthropes (Communion): While at least one unit is attuned to the Zoanthropes, their Warp Blast is resolved at Strength 6 with a range of 24\"."),), sub: ()), (runs: ((emph: "", text: "Tervigon (Communion): While at least one unit is attuned to the Tervigon, she may re-roll one of the dice when rolling for Brood Progenitor."),), sub: ()), (runs: ((emph: "", text: "Trygon Prime: The attuned unit has the Swiftstride special rule."),), sub: ()), (runs: ((emph: "", text: "Norn Emissary: The attuned unit has the Hatred special rule against the target of the Emissary's Singular Purpose."),), sub: ())))
...
#items(((runs: ((emph: "", text: "Lurk: The unit is subject to the rules for Stupidity, and counts as having failed its Stupidity test this turn."),), sub: ()), (runs: ((emph: "", text: "Feed: The unit is subject to the rules for Frenzy (including the extra Attack), and automatically fails any Leadership test to restrain from charging."),), sub: ())))
...
#namecost("FLESHBORER", "")
#para(((emph: "", text: "Range 12\", Strength 4, March & Shoot."),))
#namecost("DEVOURER", "")
#para(((emph: "", text: "Range 18\", Strength 3, Multiple Shots (2)."),))
#namecost("DEATHSPITTER", "")
#para(((emph: "", text: "Range 18\", Strength 4."),))
...
#para(((emph: "", text: "The model gains a shooting attack with range 8\", Strength 4, March & Shoot. In addition, the model strikes at +1 Initiative against models defending an obstacle."),))
...
#field("SPECIAL RULES", "Tyranid, Synapse, Synaptic Relay, Terror, Natural Armour (4+), Stomp (D6)")
#field("OPTIONS", "")
...
#para(((emph: "", text: "Range 24\", Strength 6, Armour Piercing (2), Multiple Wounds (D3)."),))
...
#field("EQUIPMENT", "Scything talons")
#field("SPECIAL RULES", "Tyranid, Synapse, Alpha Warrior, Natural Armour (5+)")
#field("OPTIONS", "")
...
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Scything talons")
#field("SPECIAL RULES", "Tyranid, Synapse, Natural Armour (5+)")
#field("OPTIONS", "")
...
#field("TROOP TYPE", "Monstrous Infantry (Tyranid)")
#field("BASE SIZE", "40x40")
#field("SPECIAL RULES", "Tyranid, Synapse, Magic Resistance (3), Natural Armour (5+)")
#namecost("WARP BLAST", "")
#para(((emph: "", text: "Range 18\", Strength 5, Armour Piercing (2)."),))
...
#para(((emph: "", text: "Range 24\", Strength 5, Armour Piercing (2), Multiple Shots (2). The impaler cannon may target a unit that is out of sight, provided it is in range, at an additional -1 To Hit modifier."),))
...
#para(((emph: "", text: "Range 18\", Strength 4. A unit that suffers one or more unsaved Wounds from barb-launchers is slowed by the detonating barbs: it suffers -2 Movement and may not march until the start of the firing player's next turn."),))
...
#field("SPECIAL RULES", "Tyranid, Synapse, Natural Armour (4+), Stomp (D6)")
#field("OPTIONS", "")
...
#para(((emph: "", text: "Range 24\", Strength 6, Armour Piercing (2), Multiple Shots (3)."),))
...
#para(((emph: "", text: "Range 36\", Strength 8, Armour Piercing (3), Multiple Wounds (D3), Multiple Shots (2)."),))
...
#para(((emph: "", text: "Range 18\", Strength 5, Armour Piercing (1), Multiple Shots (2)."),))
