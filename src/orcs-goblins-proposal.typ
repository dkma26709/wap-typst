...
#show: book.with(title: "Orcs & Goblins — Proposals 2026.1")
...
- *Savage Orc:* The model gains the Frenzy and Magical Ward (6+) special rules. This changes their Troop Type to Infantry (Character, Savage Orc). A Savage Orc Shaman can use spells from the Lore of da Big Waaagh! or da Savage Waaagh!
...
- *Night Goblin:* The model gains the Hatred (Dwarfs) and Magic Mushrooms special rules. This changes their Troop Type to Infantry (Character, Night Goblin). A Night Goblin Shaman can use spells from the Lore of da Little Waaagh! or da Bad Moon.
- *Forest Goblin:* The model gains the Forest Strider and Spider Venom special rules. This changes their Troop Type to Infantry (Character, Forest Goblin). A Forest Goblin Shaman can use spells from the Lore of da Little Waaagh! or da Spider God.
...
- *Savage Orc:* The model gains the Frenzy and Magical Ward (6+) special rules. This changes their Troop Type to Infantry (Savage Orc).
...
- *Big 'Uns:* For each Orc Warboss in your army, you may upgrade one unit of Orc Boys or Orc Boar Boyz of the same sub-species to Big 'Uns. Big 'Uns gain +1 Weapon Skill and the Mighty Blow (1) special rule. In addition, they count as Special Units.
- *Savage Orc:* The model gains the Frenzy and Magical Ward (6+) special rules. This changes their Troop Type to Cavalry (Savage Orc).
...
- *Azhag's 'Ard Armour:* Magic Armour. Medium armour. The 'Ard Armour gives Azhag the Magical Ward (5+) special rule.
...
- *Blood-Forged Armour:* Magic Armour. The Blood-forged Armour gives Grimgor a 2+ armour save and the Magical Ward (5+) special rule.
...
- *'Ardlad's Axe o' Doom:* Magic Weapon. Two hand weapons. This axe adds +1 to Borgut's Strength and allows him to re-roll failed armour saves.
...
- *Trollhide Shawl:* Magic Armour. This item gives Ogdruz the Natural Armour (6+) and Regeneration (5+) special rules.
...
- *Bonewood Staff:* Arcane Item. Staff. Bound spell. The Bonewood Staff contains the _Wurrzag's Revenge_ spell. _Wurrzag's Revenge_ is a *hex* spell, which targets all enemy Wizards within 12" of Wurrzag. Roll a D6 for each Wizard that is affected. On a roll of 1\-5 they shake off the spell, but on a roll of 6 they are turned into a Squiggly Beast and removed as a casualty, along with any mount they have, with no saves of any kind allowed. In addition, you may store one extra dice in Wizzbang the Power Squig (see below) for each Wizard that is transformed.
- *Wizzbang the Power Squig:* Arcane Item. Relic. At the end of either player's Magic phase, you can store one unused dice from your pool in the Power Squig. At the start of the next Magic phase, you must add this extra dice to your power or dispel pool as appropriate.
- *Baleful Mask:* Enchanted Item. Relic. Bound spell. The Baleful Mask contains the Gaze of Mork spell from Spells of da Big Waaagh!
...
- *Axe of Grom:* Magic Weapon. Great weapon. Attacks made with this axe have the Killing Blow special rule. In addition, Grom's Axe gains the Killing Blow special twice against Elves.
- *Lucky Banner:* Magic Standard. This is the Battle Standard. The Lucky Banner allows Grom to re-roll failed armour and invulnerable saves. This item requires Grom to be mounted on a Wolf Chariot to have any effect.
...
- *Gotkid's Beard:* Talisman. This item gives Skitgit the Magical Ward (6+) special rule.
- *Hood of Night:* Enchanted Item. This item causes friendly units of Night Goblins to treat Skitgit as if he had Leadership 9.
...
- *Moon King's Crown:* Talisman. The Moon King's Crown gives Skragrott a +1 casting bonus and the Magical Ward (4+) special rule.
...
#namecost("Big 'Uns should not cost a Warboss", "under discussion")

The Big 'Uns and Little Big 'Uns upgrades would be easier to reach than they are. Three restrictions currently stack on one two-point upgrade: it needs a Warboss in the army, the unit must be of his own sub-species, and taking it moves the unit out of Core. The direction is fewer of those three. Which of them goes, and how far, is what there is to argue about.

#field("Why", "")

One upgrade, rationed three separate ways. Each Warboss unlocks exactly one unit, and a Warboss costs 115 points before wargear, so how many units of Big 'Uns a list may field is decided by how many of its dearest characters it is willing to buy out of an allowance capped at 35% of the army. The unit must then match his sub-species, and once upgraded it stops counting as Core. Any one of the three would be enough to keep Big 'Uns uncommon; the three together make a two-point upgrade cost a Warboss.

The book keeps writing around it. Gorbad lets a list take a unit of Common Orc Big 'Uns and a unit of Common Orc Boar Boy Big 'Uns as Core instead of Special. Borgut lets one unit of Orc Big 'Uns be Core, and stands in it himself. Two special characters written to undo the same restriction is a fair sign that the restriction is tighter than the book wants it.

The Empire prices the same shape more loosely. Inner Circle Knights cost +2 points a model for +1 Strength and +1 Initiative, one unit for each character with the Master of Battle special rule, and they cannot be taken as Core. Same price, same one-unit-per-character shape, same loss of the Core slot. What differs is that the unlock is any character carrying a rule rather than a Lord in particular, and that there is no sub-species match to satisfy.

#field("The argument against", "")

The restrictions are the price. +1 Weapon Skill and Mighty Blow (1) for two points a model is efficient, and what keeps it from being an automatic purchase is that reaching it costs a Warboss. Loosen the unlock and the upgrade wants repricing, which is a larger change than it first looks.

It also removes a reason to field a Warboss. For some lists Big 'Uns are what the Warboss is bought for, and a list that no longer needs him for them may not take him at all.

#field("What it would take", "")

One clause in each of two rules, and possibly the price. Big 'Uns and Little Big 'Uns are worded identically, so whatever is settled applies twice over. Gorbad's and Borgut's rules want re-reading afterwards, since both exist to grant an exception that may no longer be exceptional.

Nothing else in the book moves.

#field("For example", "")

*The three levers, cheapest first.* Widen the unlock, so that any Orc character opens a unit rather than a Warboss alone. This is the Empire's shape and the smallest change of the three. Drop the sub-species match, so a Warboss of one kind may raise Big 'Uns of another. Or let them stay Core, which is the largest change, and the one Gorbad and Borgut already hand out by name.

*What the restriction costs today.* A list that wants two units of Big 'Uns must buy two Warbosses to unlock them, which is 230 points of characters before a single piece of wargear, each unit must match its own boss's sub-species, and both then come out of the Special allowance rather than Core.
