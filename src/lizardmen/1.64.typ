// Lizardmen 1.64 - re-typeset from the Warhammer Armies Project PDF.
...
#show: book.with(title: "Warhammer Armies Project — Lizardmen 1.64")

#cover(
  title: "Lizardmen",
  subtitle: "Warhammer Armies Project · 1.64",
...
#colophon((
  [
    ...
    Lizardmen*, version 1.64 — written and freely distributed by Mathias
    Eliasson.
  ],
  [
...
#spell("ASSAULT OF STONE", 3, cast: "12+")[_Assault of Stone_ is a *direct damage* spell. Place the small round template anywhere within 24" of the Wizard – it then scatters D3". All models under the template suffer a Strength 5 hit.]
...
#upgrade-chapter("DISCIPLINES OF THE OLD ONES")[
...
#unit("CHAMELEON STALKER",
  profiles: (
    (name: "Chameleon Stalker", m: 6, ws: 4, bs: 6, s: 4, t: 3, w: 2, i: 6, a: 2, ld: 6, points: 45),
  ),
  troop-type: "Infantry (Character, Lizardman, Skink)",
  base-size: "20x20 or 25x25",
...
#unit("TEMPLE GUARD PALANQUIN",
  ...
  special-rules: "Cold-blooded, Natural Armour (5+), Predatory Fighter, Stubborn",
  notes: [
...
#unit("SKINK SKIRMISHERS",
  profiles: (
    (name: "Skink", m: 6, ws: 2, bs: 3, s: 3, t: 2, w: 1, i: 4, a: 1, ld: 5, points: 7),
  ),
  unit-size: "10+",
  troop-type: "Infantry (Lizardman, Skink)",
  base-size: "20x20 or 25x25",
...
#unit("CHAMELEON SKINKS",
  profiles: (
    (name: "Chameleon Skink", m: 6, ws: 2, bs: 4, s: 3, t: 2, w: 1, i: 4, a: 1, ld: 5, points: 10),
  ),
  unit-size: "5+",
  troop-type: "Infantry (Lizardman, Skink)",
  base-size: "20x20 or 25x25",
...
_The Deliverance of Itza_ is a *direct damage* spell that targets all enemy units within 12" of the caster's front arc. Each target suffers 2D6 Strength 4 hits. If a target has the Daemonic, Undead or Vampiric special rules, it suffers 3D6 hits instead. Lord Kroak can choose to extend the range of this spell to 18"; if he does so, the casting value is increased to 18+. Alternatively, Lord Kroak can choose to extend the range of this spell to 24", in which case the casting value is increased to 24+.
  ...
  special-rules-body: (
    ...
    rule("First Generation Spawning")[Lord Kroak can cast _The Deliverance of Itza_ as many times per turn as he has sufficient power dice, and may use up to 6 Power Dice per casting attempt. If Lord Kroak miscasts, roll a D6; on 2+ he does not roll on the Miscast table but instead suffers a Strength 6 hit. On a roll of 1, Lord Kroak rolls on the Miscast table as normal. In either case, if the spell was cast through an Arcane Vassal, the Arcane Vassal also suffers a Strength 6 hit.],
...
#minitable(("Range", "Strength", "Special Rules"), ("18\"", "2", "Multiple Shots (3), Multiple Wounds (D3), Poisoned Attacks, Quick to Fire, Rapid Fire"))
  ],
