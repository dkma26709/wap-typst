// Lizardmen 1.6 - re-typeset from the Warhammer Armies Project PDF.
...
#show: book.with(title: "Warhammer Armies Project — Lizardmen 1.6")
...
#colophon((
  [
    ...
    Lizardmen*, version 1.6 — written and freely distributed by Mathias
    Eliasson.
  ],
  [
...
#spell("PART THE WATERS", 4, cast: "5+")[_Part the Waters_ is a special type of spell. Choose any water or marshland within 24". Treat that terrain piece as open ground until the start of the caster's next Magic phase. Any unit at least partially within it when the spell is cast or ends suffer 2D6 Strength 4 Hits (except models with the Aquatic special rule).]

#spell("EMPOWERED OBSINITE", 4, cast: "8+")[_Empowered Obsinite_ is an *augment* spell with a range of 18". The target unit gains the Armour Piercing (2) special rule until the start of the caster's next Magic phase.]

#spell("TECTONIC SHIFT", 4, cast: "8+")[_Tectonic Shift_ is a special type of spell. Choose one piece of terrain within 24". You may move the target up to 2D3" in any direction while still retaining its original facing, stopping within 1" of any other terrain. Unless it is in combat, any unit in that terrain piece is moved with it, stopping within 1" of other units. In addition, the unit is subject to Earth Tremors.]

#spell("EARTHEN RAMPARTS", 4, cast: "9+")[Remains in play. _Earthen Ramparts_ is an *augment* spell with a range of 18". While the spell is in effect, the target counts as being behind a wall (a defended obstacle that gives hard cover and a \-1 To Hit modifier to charging models in base contact with them) on all sides. The spell is immediately dispelled if the unit moves for any reason.]

#spell("ENTOMB", 4, cast: "9+")[Remains in play. _Entomb_ is a *hex* with a range of 24" that can be cast on an unengaged unit. While the spell is in effect, the target cannot move or be damaged in any way (except by spells from the Lore of Geomancy) and is treated as impassable terrain for all purposes.]

#spell("UPROOT THE MOUNTAINS", 4, cast: "9+")[_Uproot the Mountains_ is a *summoning* spell with a range of 18" that summons a brand new hill with one level, no more than 6" in diameter. Alternatively, the caster can target an existing hill within 18" and remove it from play. Any unit on or under the hill when the spell is cast are subject to Earth Tremors.]

#spell("CAVERNOUS CREVASSE", 4, cast: "10+")[_Cavernous Crevasse_ is a *direct damage* spell. Extend a straight line, 12" in length, with its starting point anywhere within 18" of the caster. Each model in the way (determined using the line template) must roll a D6 per Wound on their profile – for each roll of a 4+ they suffer a Wound which Ignores Armour Saves and Regeneration.]

#spell("SEISMIC UPHEAVAL", 4, cast: "10+")[_Seismic Upheaval_ is a *hex* with a range of 24". All models in the unit must take a Dangerous Terrain test and suffer a \-1 To Hit penalty in close combat and with missile weapons until the start of the caster's next turn until the start of the caster's next Magic phase.]

#spell("TELEPATHIC SUMMONS", 4, cast: "10+")[_Telepathic Summons_ is a *conveyance* spell that targets a friendly unit within 24". The target is immediately picked up and may be moved to any position on the battlefield within 12" of the caster, just like a summoning spell.]
...
#spell("THE GREAT LEVELLER", 4, cast: "15+")[_The Great Leveller_ is a special type of that targets all units (friend and foe, including the caster and their unit) within 12", even if they are engaged in close combat. All target units suffer 3D6 Strength 5 Hits.]
]
...
#upgrade("ARCANE MIGHT", 40)[The Slann Mage-Priest gains +1 to cast and dispel.]
...
#upgrade("HARMONIC CONVERGENCE", 30)[The Slann Mage-Priest rolls an additional dice whenever they attempt to channel power or dispel dice.]
...
#magic-weapon("THE LASH OF ITZAOTYL", 30)[This weapon gives the wielder the Always Strikes First special rule. In addition, any Monster successfully hit by the lash must pass a Leadership test. If failed, it cannot Attack this close combat phase.]

#magic-weapon("STAFF OF THE LOST SUN", 30)[This weapon uses the following profile:
...
#magic-weapon("STAFF OF SOTEK", 15)[Skink Priest only. This weapon has the following profile:
...
#unit("SLANN MAGE-PRIEST",
  first: true,
  profiles: (
    (name: "Slann Mage-Priest", m: 4, ws: 1, bs: 3, s: 3, t: 4, w: 5, i: 1, a: 0, ld: 9, points: 300),
...
- May take Disciplines of the Old Ones up to a total of 100 points
- May take Magic Items up to a total of 100 points
  ...
  upgrades: (
    rule("Battle Standard")[The Battle Standard Bearer can have a magic banner with no points limit. However, a Slann carrying a magic standard can only carry other magic items up to a total of 50 points.],
  ),
...
- The Skinks may choose one of the following:
  ...
  - Replace shields with shortbows +3 points/model
  - Javelins +4 points/model
- May take a Blessed Spawning +1 point/model
...
- May replace blowpipes with one of the following:
  ...
  - Javelins & shields +3 points/model
- May take a Blessed Spawning +1 point/model
- May upgrade one Skink to a Leader +5 points
- May upgrade one Skink to a Musician +5 points
  ],
...
#unit("CHAMELEON SKINKS",
  profiles: (
    (name: "Chameleon Skink", m: 6, ws: 2, bs: 4, s: 3, t: 2, w: 1, i: 4, a: 1, ld: 5, points: 5),
  ),
  unit-size: "10+",
  troop-type: "Infantry (Lizardman, Skink)",
  base-size: "20x20 or 25x25",
  equipment: "Hand weapon, shield",
  options: [
- May choose with one of the following:
  - Replace shields with blowpipes +3 points/model
  - Slings +4 points/model
  - Javelins +5 points/model
- May take a Blessed Spawning +1 point/model
- May upgrade one Skink to a Leader +5 points
- May upgrade one Skink to a Musician +5 points
  ],
...
- May choose one of the following:
  ...
  upgrades: (
    rule("The Blazing Configuration of Chotec")[The Dread Saurian gains the Flaming Attacks special rule and causes 2D6 Strength 3 Flaming Impact Hits.],
    rule("The Golden Shroud of Tlazcotl")[All attacks targeting the Dread Saurian suffer a \-1 To Hit modifier. In addition all models which are considered Daemonic or Undead in base contact with the Dread Saurian gain the Always Strikes Last special rule.],
    rule("Quetzl's Flawless Heartstone")[The Dread Saurian gains the Unbreakable special rule and reduces its Movement rate to 5, but increases its Toughness to 8.],
    rule("The Shadow Rebus of Huanchi")[The Dread Saurian gains the Ambushers deployment special rule and +1 Movement. Models firing at it as part of a Stand & Shoot charge reaction must re-roll successful hits.],
    rule("Tepok's Crystalline Eye")[A Dread Saurian bearing the crystal known as the Eye of Tepok gains a Ward save (4+) against non-magical attacks.],
  ),
  order: ("troop-type", "base-size", "options", "special-rules", "upgrades"),
)
...
#unit("LORD MAZDAMUNDI",
  ...
  profiles: (
    (name: "Lord Mazdamundi", m: "-", ws: 2, bs: 3, s: 3, t: 4, w: 5, i: 2, a: 1, ld: 9, points: 700),
...
Magic or Geomancy.
  ...
  special-rules: "Cold-blooded, Impact Hits (D6+1) (Zlaaq only), Immunity (Psychology), Natural Armour",
  special-rules-body: [
*(2+), Stubborn, Telepathic Confabulation, Ward Save (4+)*
...
#unit("LORD KROAK",
  ...
  profiles: (
    (name: "Lord Kroak", m: 4, ws: 0, bs: 0, s: 3, t: 5, w: 6, i: 0, a: 0, ld: 9, points: 450),
    (name: "Skink Attendant", m: "-", ws: 2, bs: 3, s: 3, t: "-", w: "-", i: 4, a: 1, ld: "-", points: ""),
  ),
...
#unit("KROQ-GAR",
  ...
  special-rules: "Blood Frenzy (Grymloq only), Cold-blooded, Multiple Wounds (D3) (Grymloq only), Predatory Fighter (Kroq-Gar only), Natural Armour (2+)",
  special-rules-body: (
