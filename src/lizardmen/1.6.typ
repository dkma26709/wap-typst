...
_The Great Leveller_ is a special type of that targets all units (friend and foe, including the caster and their unit) within 12", even if they are engaged in close combat. All target units suffer 3D6 Strength 5 Hits.
]
...
#namecost("ARCANE MIGHT", "40 points")

The Slann Mage-Priest gains +1 to cast and dispel.
...
#namecost("STAFF OF THE LOST SUN", "30 points")

This weapon uses the following profile:
...
#namecost("STAFF OF SOTEK", "15 points")

Skink Priest only. This weapon has the following profile:
...
#field("SPECIAL RULES", "Cold-blooded, Impact Hits (D6+1) (Zlaaq only), Immunity (Psychology), Natural Armour")
...
#field("SPECIAL RULES", "Blood Frenzy (Grymloq only), Cold-blooded, Multiple Wounds (D3) (Grymloq only), Predatory Fighter (Kroq-Gar only), Natural Armour (2+)")
