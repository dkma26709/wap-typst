...
#book-meta(
  ...
  version: "1.62",
  layout: "army",
  cover: "covers/lizardmen/1.62.png",
  align: "order",
)
...
#cover(
  ...
  art: "/assets/covers/lizardmen/1.62.png",
)
...
- *Battle Standard:* The Battle Standard Bearer can have a magic banner with no points limit. However, a Slann carrying a magic standard can only take other magic items and/or Disciplines of the Old Ones up to a total of 50 points.
...
- *Battle Standard:* The Battle Standard Bearer can have a magic banner with no points limit. However, a model carrying a magic standard can only take other magic items and/or Blessed Spawnings up to a total of 25 points.
...
- *Tepok's Crystalline Eye:* The Dread Saurian gains a Ward save (5+) which is reduced to a Ward save (6+) against Magical Attacks.
