// Daemons of Chaos 1.71 - re-typeset from the Warhammer Armies Project PDF.
...
#show: book.with(title: "Warhammer Armies Project — Daemons of Chaos 1.71")
...
#colophon((
  [
    ...
    Daemons of Chaos*, version 1.71 — written and freely distributed by Mathias
    Eliasson.
  ],
  [
...
Models with this special rule have the Fear, Magical Attacks and Unbreakable special rules (including mounts). In addition, models that are not mounts have a 5+ Ward save which gets reduced to a 6+ Ward save against Magical Attacks.
]
...
- *Daemon of Slaanesh:* A Daemon of Slaanesh has the Hatred (Daemons of Khorne) and Armour Piercing (1) special rules. For each unsaved Wound they cause in close combat, the model may may an additional Attack. These additional Attacks cannot generate further attacks.
...
#spell("SCIONS OF THE DARK GODS", "Lore Attribute")[Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemonic unit within 12", just like a summoning spell.]
...
#spell("CHILDREN OF NURGLE", "Lore Attribute")[Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Nurgle unit within 12", just like a summoning spell.]
...
#spell("BORN OF DAMNATION", "Lore Attribute")[Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Slaanesh unit within 12", just like a summoning spell.]
...
#spell("FIRES OF CHANGE", "Lore Attribute")[Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Tzeentch unit within 12", just like a summoning spell.]
...
#upgrade("WARD OF CHAOS", 30)[The Daemon has the Ward save (3+) special rule against missile attacks.]

#upgrade("RADIANCE OF DARK GLORY", 25)[The Daemon and all friendly units within 12" suffers one less wound than normal when taking Daemonic Instability tests.]
...
#minitable(("Range", "Strength", "Special Rules"), ("12\"", "6", "Quick to Fire"))
]
...
#upgrade("INCORPOREAL STRIKE", 15)[Enemies Wounded by this Daemon must re-roll successful armour saves.]
...
#upgrade("DARK BLESSING", 10)[The Daemon gains a Ward save (2+) against the first Wound it suffers in the battle.]
...
#upgrade("EXTREME CONTAGION", 30, only: "Great Unclean One")[All enemy units within 6" of the Daemon at the start of any close combat phase suffer D6 Hits that Wound on a 5+ and Ignores Armour saves. This has no effect on Daemons of Nurgle.]
...
#upgrade("NOXIOUS VAPOURS", 25)[All enemy models in base contact with this Daemon is subject to the Always Strikes Last special rule in close combat. This has no effect on Daemons of Nurgle.]
...
#upgrade("CURSED ICHOR", 20)[Roll a D6 every time the Daemon suffers an unsaved Wound; on a 5+, the model that struck the blow suffers a Wound which Ignores Armour saves themselves.]
...
#magic-weapon("THE ETERNAL BLADE", 40)[Daemon Prince only. Roll a D3 at the start of each round of combat – the bearer’s Weapon Skill, Strength, Initiative and Attacks are increased by this amount until the end of the phase.]
]
...
#magic-standard("BANNER OF INFERNAL FIRE", 25)[Bound Spell, Power Level 5. The Banner of Infernal Fire contains a *direct damage* spell that targets all enemy units within 6" (including units in close combat). The target units suffer D6 Strength 5 Hits with the Flaming Attacks special rule.]
]
...
#magic-weapon("HARVESTER OF SKULLS", 20)[This weapon makes the model's Killing Blow special rule take effect on a 4+.]
...
#magic-armour("ARMOUR OF KHORNE", 25)[Medium armour. Magic weapons carried by enemy models lose all their magical abilities whilst the bearer remains in contact with the Daemon.]

#magic-armour("ARMOUR OF SCORN", 15)[Light armour. The wearer gains a Ward save (6+) against non-magical attacks.]
]

#magic-item-section("talisman")[
#talisman("THE BLOODY SHACKLE", 15)[One use only. The Bloody Shackle may be used at the start of any phase. Until the end of that turn, the wearer gains the Regeneration (4+) special rule.]
...
#magic-weapon("BILEBLADE", 5)[Great Unclean One only. At the start of each of your Magic phases, the bearer can choose to suffer one Wound with no saves allowed. If they do so, they gain +1 Power Dice for the remainder of this Magic phase.]
]

#magic-item-section("arcane")[
#arcane-item("DOOMSDAY BELL", 35)[Bound Spell, Power Level 5. The Doomsday Bell contains a *summoning* spell with a range of 18" that can target units of Plague Bearers, Nurglings or Plague Toads. The target unit immediately gains D6 Wounds worth of models.]

#arcane-item("STAFF OF NURGLE", 35)[Bound Spell, Power Level 5. The Staff of Nurgle contains the _Rancid Visitation_ spell from the Lore of Nurgle.]

#arcane-item("TOME OF A THOUSAND POXES", 30)[The bearer of this item gains a +1 casting bonus. This bonus increases by +1 for each subsequent spell successfully cast by the bearer on the same target during the current Magic phase.]
]
...
#magic-item-section("weapon", first: true)[
#magic-weapon("ETHERBLADE", 25)[The Etherblade gives the wielder the Ignores Armour Saves special rule. In addition, enemy models Wounded by it must re-roll successful Ward saves.]
...
#enchanted-item("GIRDLE OF THE REALM-RACER", 15)[Mounted model only. The wearer gains the Fly (10) and Strider special rules.]
]
...
#magic-item-section("weapon", first: true)[
#magic-weapon("STAFF OF CHANGE", 25)[Any model that suffers one or more unsaved Wounds from the Staff of Change must immediately pass a Toughness test or suffer an additional D6 Wounds with the Ignores Armour Saves special rule. If a multiple- Wound model loses its last Wound to the Staff of Change, all models within D6" immediately suffer a single Strength 5 hit.]
...
#magic-weapon("BLADE OF FATE", 10)[For every 6 rolled when rolling To Hit, the wielder may re-roll a failed To Hit, To Wound or Ward save roll of their choosing this close combat phase.]
...
#magic-weapon("WAND OF WHIMSY", 30)[Whenever the bearer successfully casts or dispels a spell, roll a D6 – the Wand of Whimsy gains a charge token on a roll of 5+. The Wand of Whimsy grants the bearer a bonus to both Strength and Attacks equal to the number of charge tokens for the remainder of the game.]

#magic-weapon("THE CHROMATIC TOME", 15)[You can choose to re-roll the Winds of Magic dice in your turn. However, if you do so, your opponent can also re-roll the Winds of Magic dice in their next turn if they wish. In either case, all of the Winds of Magic dice must be re-rolled.]
]
...
#magic-standard("BANNER OF CHANGE", 25)[Bound Spell, Power Level 4. The Banner of Change contains a *hex* spell that targets all enemy units in base contact. The target units suffer 2D6 Strength 3 Hits.]

#magic-standard("ICON OF SORCERY", 25)[The unit carrying this standard gains a +1 bonus casting bonus.]
...
#magic-item-section("arcane")[
#arcane-item("NINE-EYED TOME", 30)[The bearer can re-roll one casting or dispel attempt each Magic phase.]
]
= LORDS
...
- Fire
- Metal
- Nurgle (Daemon of Nurgle only)
- Shadow
- Slaanesh (Daemon of Slaanesh only)
- Tzeentch (Daemon of Tzeentch only)
  ],
  special-rules: "Daemonic",
  special-rules-body: (
    rule("Chaos Armour")[Models with this special rule add +1 to their armour saves if they wear light, medium or heavy armour.],
  ),
  options: [
...
- May take Daemonic Gifts and/or Magic Items up to a total of 100 points
  ...
  notes: [
- A Daemon Prince with the Mark of Tzeentch, Nurgle or Slaanesh must use the Lore of Tzeentch, Nurgle, or Slaanesh, respectively.
  ],
)
...
#unit("GAUNT SUMMONER",
  ...
  magic: "A Gaunt Summoner is a Level 3 Wizard who chooses spells from the Lore of Tzeentch.",
  equipment: "Hand weapon",
  special-rules: "Daemon of Tzeentch",
  special-rules-body: (
    rule("Summon Daemons")[Innate Bound spell (power level 8). _Summon Daemons_ is a *summoning* spell with a range of 18" that can target units of Pink Horrors, Brimstone Horrors, Screamers or Flamers. The target unit immediately gains D6 Wounds worth of models.],
  ),
  options: [
...
- May be upgraded to one of the following:
  ...
  - Daemon of Tzeentch +15 points
- May choose one of the following:
  - Light armour +12 points
  - Medium armour +24 points
- May have the Fly (8) special rule +25 points
...
- An Exalted Daemon with the Mark of Tzeentch, Nurgle or Slaanesh must use the Lore of Tzeentch, Nurgle, or Slaanesh, respectively.
  ],
)
...
- *Harmonic Alignment:* All friendly Daemons of Slaanesh within 6" of an Infernal Enrapturess may re-roll failed Ward saves.
...
#unit("JUGGERNAUT",
  compact: true,
  profiles: (
    (name: "Juggernaut", m: 7, ws: 4, bs: 0, s: 5, t: 4, w: 3, i: 2, a: 3, ld: 7, points: ""),
  ),
...
#minitable(("Range", "Strength", "Special Rules"), ("12\"", "3", "Flaming Attacks, Multiple Shots (2), Quick to Fire"))
  ],
...
- May upgrade one Pink Horror to a Standard Bearer +10 points
  ...
  order: ("unit-size", "troop-type", "base-size", "equipment", "magic", "options", "special-rules"),
)
...
#unit("BRIMSTONE HORRORS",
  profiles: (
    (name: "Brimstone Horrors", m: 4, ws: 2, bs: 3, s: 2, t: 2, w: 2, i: 3, a: 2, ld: 7, points: 12),
  ),
  unit-size: "10+",
  troop-type: "Infantry (Daemon)",
  base-size: "25x25 or 30x30",
...
#unit("BLOODCRUSHERS",
  profiles: (
    (name: "Bloodletter", m: 5, ws: 5, bs: 3, s: 4, t: 3, w: 1, i: 4, a: 1, ld: 7, points: 60),
    (name: "Juggernaut", m: 7, ws: 4, bs: 0, s: 5, t: 4, w: 3, i: 2, a: 3, ld: 7, points: ""),
  ),
  unit-size: "3+",
...
#unit("BLOOD CHARIOT",
  profiles: (
    (name: "Blood Chariot", m: 6, ws: "-", bs: "-", s: 5, t: 5, w: 5, i: "-", a: "-", ld: "-", points: 150),
    (name: "Bloodletter", m: "-", ws: 5, bs: 3, s: 4, t: "-", w: "-", i: 4, a: 1, ld: 7, points: ""),
    (name: "Juggernaut", m: "-", ws: 4, bs: 0, s: 5, t: "-", w: "-", i: 2, a: 3, ld: 7, points: ""),
  ),
  troop-type: "Chariot (Armour Save 4+)",
  crew: "2 Bloodletters (Daemon)",
...
#minitable(("Range", "Strength", "Special Rules"), ("18\"", "4", "Flaming Attacks, Multiple Shots (D6), Quick to Fire"))
  ],
...
#minitable(("Range", "Strength", "Special Rules"), ("12", "D3+3", "Flaming Attacks, Multiple Shots (Artillery Dice + D6), Rapid Fire, Slow to Fire"))

\- *Pink Fire:* Pink Fire is a fire thrower that uses the following profile:

#minitable(("Range", "Strength", "Special Rules"), ("n/a", "D6", "Flaming Attacks, Slow to Fire"))
  ],
)
...
#minitable(("Range", "Strength", "Special Rules"), ("18\"", "4", "Flaming Attacks, Multiple Shots (2D6), Quick to Fire"))
  ],
...
#minitable(("Range", "Strength", "Special Rules"), ("12-36\"", "3", "Slow to Fire"))
...
#minitable(("Range", "Strength", "Special Rules"), ("12-48\"", "10", "Flaming Attacks, Multiple Wounds (D6/D3), Slow to Fire"))
  ],
)
...
#minitable(("Range", "Strength", "Special Rules"), ("12\"", "4", "Multiple Wounds (D3), Quick to Fire"))
  ],
  options: [
...
#unit("CONTORTED EPITOME",
  profiles: (
    (name: "Contorted Epitome", m: 6, ws: 5, bs: 0, s: 4, t: 4, w: 4, i: 5, a: 4, ld: "-", points: 175),
  ...
  special-rules: "Daemon of Slaanesh",
  special-rules-body: (
    rule("Acquiescence")[Innate Bound Spell, Power Level 5. The Contorted Epitome contains the Acquiescence spell from the Lore of Slaanesh.],
    ...
    rule("Swallow Energy")[A Contorted Epitome's Ward Save is increased by +1 for every point of Strength above 3 that every attack targeting it has. So, against a Strength 4 Attack it has 4+ Ward save, against Strength 5 it has a 3+ Ward save.],
  ),
...
#unit("BE'LAKOR",
  ...
  profiles: (
    (name: "Be'lakor", m: 8, ws: 9, bs: 5, s: 6, t: 5, w: 5, i: 8, a: 5, ld: 10, points: 520),
  ),
  ...
  special-rules-body: (
    ...
    rule("Shadow Form")[Be'lakor has a 6+ Ward save, and any missile attacks targeting him suffer \-2 To Hit.],
  ),
)
...
#unit("SKARBRAND",
  ...
  special-rules: "Aura of Fury, Daemon of Khorne, Frenzy, Hatred, Killing Blow, Magic Resistance (1)",
  special-rules-body: (
...
#unit("KU'GATH PLAGUEFATHER",
  ...
  magic-items: (
    rule("Necrotic Missiles")[Magic Weapon. This missile attack is fired according to the rules for a stone thrower, except Ku'gath may move and fire. It has a range of 12\-36", Strength 5, Ignores Armour Saves and Slow to Fire special rules. In the event of a misfire, Ku'gath has accidentally squashed the Nurgling and the shot has no effect.],
  ),
...
#unit("AZAZEL",
  ...
  special-rules-body: (
    ...
    rule("Dark Halo")[Azazel may re-roll failed Ward saves.],
  ),
)
...
#unit("SYLL'ESSKE",
  ...
  special-rules: "Daemon of Slaanesh, Terror",
  special-rules-body: (
...
#unit("SYNESSA",
  ...
  troop-type: "Monstrous Creature (Special Character, Daemon)",
  base-size: "100x50",
  magic: "Synessa are a Level 4 Wizard who uses spells from the Lore of Slaanesh.",
  magic-items: (
    rule("Staff of Slaanesh")[Arcane Item. The Staff of Slaanesh contains a Bound Spell, Power Level 4. This is a *direct damage* spell with a range of 18". The target unit suffers 2D6 Wounds. Saves are taken as normal.],
  ),
  ...
  special-rules-body: (
    ...
    rule("Whispers of Doubt")[Innate Bound Spell, power level 3. _Whispers of Doubt_ is a *hex* spell with a range of 24". The target unit must take a Leadership test using an additional D6; if failed, all close combat attacks targeting that unit gain +1 To Hit until the start of your next Magic phase.],
  ),
)
...
At the start of each Magic phase, decide which head Kairos is using this turn. He may only cast spells known to that head during this turn, as well as the Lore of Tzeentch.
  ...
  magic-items: (
    rule("Staff of Tomorrow")[Arcane Item. Kairos allows you to re-roll a single D6 of your choice once per turn – declare before you make the re-roll. If this is used to re-roll a single dice from a batch of 2D6, 3D6 etc, the other dice in that batch cannot be re-rolled.],
  ),
  special-rules: "Daemon of Tzeentch, Fly (8), Loremaster (Lore of Tzeentch)",
  special-rules-body: (
    rule("Oracle of Eternity")[Kairos Fateweaver has a 6+ Ward save.],
...
#unit("AMON 'CHAKAI",
  ...
  special-rules: "Barrage of Knowledge, Daemon of Tzeentch, Fly (8)",
  special-rules-body: (
    rule("Daemonic Aura")[Amon 'Chakai and all friendly units within 6" gain +1 to their Ward saves (to a maximum of 3+) against non-Magical Attacks.],
...
#unit("U'ZHUL THE SKULLTAKER",
  ...
  profiles: (
    (name: "Skulltaker", m: 5, ws: 8, bs: 5, s: 5, t: 4, w: 2, i: 7, a: 4, ld: 8, points: 175),
...
#unit("KARANAK",
  ...
  special-rules: "Daemon of Khorne, Hatred, Magic Resistance (2), Natural Armour (6+)",
  special-rules-body: (
    ...
    rule("Hounds of the Blood Hunt")[If Karanak is included in your army, you may upgrade one unit of Flesh Hounds to the Hounds of the Blood Hunt Host for a cost of +2 points per model. For every unsaved Wound caused by this unit in close combat, they regain 1 Wound's worth of models, just like a summoning spell.],
  ),
  notes: [
- Karanak may never be the Army General, but may join units of Flesh Hounds.
  ],
)
...
#unit("SKAARAC THE BLOODBORN",
  ...
  profiles: (
    (name: "Scaarac", m: 7, ws: 5, bs: 0, s: 6, t: 6, w: 6, i: 4, a: 6, ld: 7, points: 325),
  ),
  troop-type: "Monster (Special Character, Daemon)",
  base-size: "100x150",
  equipment: "Light armour",
  ...
  special-rules-body: (
    rule("Burning Blood")[Scaarac has a Breath Weapon Attack with Strength 4 and the Ignores Armour Saves special rule.],
...
#unit("EPIDEMUS",
  ...
  profiles: (
    (name: "Epidemius", m: 4, ws: 6, bs: 5, s: 5, t: 5, w: 2, i: 4, a: 3, ld: 8, points: 185),
    (name: "Palanquin of Nurgle", m: 4, ws: 2, bs: 2, s: 2, t: "-", w: "-", i: 3, a: 8, ld: 7, points: ""),
  ),
  troop-type: "Infantry (Special Character, Daemon)",
  base-size: "50x50",
...
#chart((("Wounds", "Effect"), ("0-6", "No effect."), ("7+", "All models in the unit gain +1 Strength."), ("14+", "All models in the unit gain +1 Toughness."), ("21+", "All models in the unit gain the Killing Blow special rule."), ("28+", "All models in the unit re-roll failed Ward saves.")))
  ],
  notes: [
- Epidemius has a Line of Sight value of 2 and Unit Strength 4.
  ],
)
