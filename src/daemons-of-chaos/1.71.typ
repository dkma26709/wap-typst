...
Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemonic unit within 12", just like a summoning spell.
...
Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Nurgle unit within 12", just like a summoning spell.
...
Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Slaanesh unit within 12", just like a summoning spell.
...
Whenever a spell from this lore is cast, roll a D6 for each unsaved Wound caused by it; on a 5+, add 1 Wound's worth of models to one friendly Daemons of Tzeentch unit within 12", just like a summoning spell.
...
The Daemon and all friendly units within 12" suffers one less wound than normal when taking Daemonic Instability tests.
...
Great Unclean One only. All enemy units within 6" of the Daemon at the start of any close combat phase suffer D6 Hits that Wound on a 5+ and Ignores Armour saves. This has no effect on Daemons of Nurgle.
...
All friendly units attempting to deploy using the Summoned from Beyond special rule within 12" bearer of this item may re-roll the dice to determine if they arrive this turn.
...
This weapon makes the model's Killing Blow special rule take effect on a 4+.
...
#namecost("ARMOUR OF SCORN", "15 points")
...
Bound Spell, Power Level 5. The Doomsday Bell contains a *summoning* spell with a range of 18" that can target units of Plague Bearers, Nurglings or Plague Toads. The target unit immediately gains D6 Wounds worth of models.

#namecost("STAFF OF NURGLE", "35 points")

Bound Spell, Power Level 5. The Staff of Nurgle contains the _Rancid Visitation_ spell from the Lore of Nurgle.

#namecost("TOME OF A THOUSAND POXES", "30 points")

The bearer of this item gains a +1 casting bonus. This bonus increases by +1 for each subsequent spell successfully cast by the bearer on the same target during the current Magic phase.
...
Any model that suffers one or more unsaved Wounds from the Staff of Change must immediately pass a Toughness test or suffer an additional D6 Wounds with the Ignores Armour Saves special rule. If a multiple- Wound model loses its last Wound to the Staff of Change, all models within D6" immediately suffer a single Strength 5 hit.
...
#namecost("THE CHROMATIC TOME", "15 points")
...
The unit carrying this standard gains a +1 bonus casting bonus.
...
- *Chaos Armour:* Models with this special rule add +1 to their armour saves if they wear light, medium or heavy armour.
...
#field("MAGIC", "A Gaunt Summoner is a Level 3 Wizard who chooses spells from the Lore of Tzeentch.")
#field("EQUIPMENT", "Hand weapon")
#field("SPECIAL RULES", "Daemon of Tzeentch")

- *Summon Daemons:* Innate Bound spell (power level 8). _Summon Daemons_ is a *summoning* spell with a range of 18" that can target units of Pink Horrors, Brimstone Horrors, Screamers or Flamers. The target unit immediately gains D6 Wounds worth of models.
...
#entry("EXALTED DAEMON", first: true)
#profile(
...
- *Acquiescence:* Innate Bound Spell, Power Level 5. The Contorted Epitome contains the Acquiescence spell from the Lore of Slaanesh.
...
- *Swallow Energy:* A Contorted Epitome's Ward Save is increased by +1 for every point of Strength above 3 that every attack targeting it has. So, against a Strength 4 Attack it has 4+ Ward save, against Strength 5 it has a 3+ Ward save.
...
- *Shadow Form:* Be'lakor has a 6+ Ward save, and any missile attacks targeting him suffer \-2 To Hit.
...
#field("SPECIAL RULES", "Aura of Fury, Daemon of Khorne, Frenzy, Hatred, Killing Blow, Magic Resistance (1)")
...
- *Gnarlrod of Nurgle:* Arcane Item. Bound Spell, Power Level 4. The Gnarlrod of Nurgle contains a direct damage spell with a range of 24". When cast, roll a D6; this is the number of enemy units affected by the spell, chosen by Rotigus. Each affected unit suffers D6 Strength 3 Hits which Ignores Armour Saves.
...
#field("SPECIAL RULES", "Daemon of Slaanesh, Terror")
...
#field("TROOP TYPE", "Monstrous Creature (Special Character, Daemon)")
#field("BASE SIZE", "100x50")
#field("MAGIC", "Synessa are a Level 4 Wizard who uses spells from the Lore of Slaanesh.")
#field("MAGIC ITEMS", "")

- *Staff of Slaanesh:* Arcane Item. The Staff of Slaanesh contains a Bound Spell, Power Level 4. This is a *direct damage* spell with a range of 18". The target unit suffers 2D6 Wounds. Saves are taken as normal.
...
- *Whispers of Doubt:* Innate Bound Spell, power level 3. _Whispers of Doubt_ is a *hex* spell with a range of 24". The target unit must take a Leadership test using an additional D6; if failed, all close combat attacks targeting that unit gain +1 To Hit until the start of your next Magic phase.
...
- *Staff of Tomorrow:* Arcane Item. Kairos allows you to re-roll a single D6 of your choice once per turn – declare before you make the re-roll. If this is used to re-roll a single dice from a batch of 2D6, 3D6 etc, the other dice in that batch cannot be re-rolled.

#field("SPECIAL RULES", "Daemon of Tzeentch, Fly (8), Loremaster (Lore of Tzeentch)")

- *Oracle of Eternity:* Kairos Fateweaver has a 6+ Ward save.
...
#field("SPECIAL RULES", "Barrage of Knowledge, Daemon of Tzeentch, Fly (8)")
...
#entry("U'ZHUL THE SKULLTAKER", first: true)
...
#field("SPECIAL RULES", "Daemon of Khorne, Hatred, Magic Resistance (2), Natural Armour (6+)")
...
- *Burning Blood:* Scaarac has a Breath Weapon Attack with Strength 4 and the Ignores Armour Saves special rule.
