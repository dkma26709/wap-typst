// Ogre Kingdoms 3.1 - House Rules.
//
// A fork of src/ogre-kingdoms/3.1.typ, kept in git so a change is a diff and an
// upstream release is a three-way merge. What it changes and why is recorded in
// editions/house/ogre-kingdoms/3.1.toml, which is the only place that reasoning lives.
...
#show: book.with(title: "Ogre Kingdoms — House Rules 2026.1")
