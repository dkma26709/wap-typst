...
_Voracious Maw_ is a *summoning* spell. Place the large round template anywhere within 24" of the Wizard. The template is considered Dangerous Terrain for all models, except that all tests fail on a 1\-2 rather than a 1. If the Voracious Maw inflicts five or more unsaved Wounds in a single phase, the template is removed.
...
*Certain models are able to spend points on a Big Name, as detailed in the army list. No big name may be taken more than once in the same army.*
...
Tyrants only. Any friendly unit within 12" of a Kineater may re-roll failed Panic tests.
...
#namecost("FROSTSHARD JAVELINS", "30 points")

Hunter only. Great Throwing Spear. Attacks made with these javelins have the Ice Attacks special rule.

#namecost("THE FANG OF GHUR", "20 points")

The wielder of this weapon gains the Frenzy and Armour Piercing (1) special rules.

#namecost("SKY-TITAN SCATTER PISTOLS", "20 points")

Brace of Ogre Pistols. All shots from these weapons are resolved at Strength 5.
...
For every successfully Wound this weapon inflicts on an enemy Character, Monstrous Creature or Monster, that model suffer \-1 Strength and Toughness for the remainder of the game.
...
Butcher or Slaughtermaster only. Every time the wielder causes an unsaved wound with the Splatter- cleaver, he gains +1 Leadership for the duration of the close combat round.

#entry("MAGIC ARMOUR")
#namecost("GREEDY FIST", "40 points")
...
#entry("TALISMANS")
#namecost("GNOBLAR THIEFSTONE", "40 points")
...
#namecost("BATTERED TALISMAN", "25 points")

The bearer of this item gains a 4+ Ward save against Attacks with Strength 5 or more.

#namecost("CATHAYAN JET PENDANT", "25 points")

The bearer of the Cathayan Jet gains the Magic Resistance (3) special rule. This has no effect on spells from the Lore of Yin and Yang.
...
#namecost("SHRUNKEN PRIEST HEAD", "20 points")

Butcher or Slaughtermaster only. The bearer of this item gains a 5+ Ward save against the first wounding hit each phase.

#namecost("WYRDSTONE NECKLACE", "20 points")

The wearer of the Wyrdstone Necklace gains a 5+ Ward save. However, they must take a pass Toughness test at the start of each of their turns or suffer a wound with no saves allowed.
...
One use only. This item can be used at the start of any of your Magic phase. For the duration of this turn, the bearer may re-roll failed casting attempts.

#namecost("FLASK OF CONGEALED", "")
#namecost("MAW-JUICES", "20 points")

Model with Great Mawpot only. One use only. This item can be used at the start of any of your Magic phases. For the duration of this turn, you may add one free power dice to each of the model's casting attempts.

#namecost("BLOODROCK TALISMAN", "20 points")

The bearer of this item gains a +2 dispel bonus if they are within 12" of the casting Wizard.

#namecost("WIZARDFLESH APRON", "20 points")

Wizard with the Lore of the Great Maw only. At the start of each of your Magic phases, the bearer of this item can pick one additional spell from the Lore of the Great Maw of those normally available to them and cast it this turn.
...
#namecost("GNOBLAR BLAST KEG", "25 points")

Tyrant or Bruiser only. One use only. This item can be used during any of your Shooting phases. Place the small round template anywhere within 6" – it scatters D3". Any model touched by the template suffers a Strength 3 Hit with the Armour Piercing (1) special rule. The model under the whole suffers a Strength 6 Hit with the Armour Piercing (1) and Multiple Wounds (D3) special rules.
...
#namecost("ELIXIR OF FROSTWYRM", "15 points")
...
If the unit carrying the this standard is in base contact with an enemy Troop Type with the same or higher Unit Strength as them, all models in the unit re-roll failed To Hit and To Wound rolls in the first round of that combat. However, they may not Overrun and must Pursue the enemy if possible.
...
The unit carrying this standard re-roll failed To Wound rolls for their Impact Hits.

#namecost("RAGBANNER", "15 points")

The unit carrying this standard rolls have the Cold- blooded special rule when taking Panic tests.

= LORDS

#entry("TYRANT", first: true)
#profile(
...
#field("MAGIC", "A Slaughtermaster is a Level 3 Wizard who uses spells from the Lore of Beasts, Heavens, Death or the Great")
...
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "A Butcher is a Level 1 Wizard who uses spells from the Lore of Beasts, Heavens, Death or the Great Maw.")
...
#field("SPECIAL RULES", "Loner, Natural Armour (6+), Ogre Charge, Scouts")
...
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Hand weapon, gut-plate")
#field("MAGIC", "A Firebelly is a Level 1 Wizard who uses spells from the Lore of Fire.")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Flammable, Forest Strider, Hill Strider, Ice Attacks, Loner, Magical Attacks")
...
#field("TROOP TYPE", "Mosntrous Beast (Animal)")
...
#field("BASE SIZE", "50x100")
#field("SPECIAL RULES", "Frenzy, Impact Hits (D3), Natural Armour (6+)")
#field("NOTES", "")
...
#field("EQUIPMENT", "Hand weapon, throwing weapon")
#field("OPTIONS", "")
...
#field("DRAWN BY", "1 Young Rhinox (Animal)")
#field("BASE SIZE", "50x100")
#field("EQUIPMENT", "Hand weapon, gut-plate")
...
- *Trappers:* Enemy units that successfully charge a unit of Gnoblar Trappers' front must take 1 Dangerous Terrain test for each Trapper in the unit as soon as the charge is completed.

#entry("GNOBLAR SCRAPLAUNCHER")
#profile(
...
#entry("GRIMHORN RHINOX RIDERS", first: true)
#profile(
...
#field("MOUNT", "Grimhorn Rhinox (Animal)")
#field("BASE SIZE", "50x100")
#field("EQUIPMENT", "Hand weapon, light armour, gut-plate")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Frenzy, Impact Hits (D3), Natural Armour (5+)")
#field("NOTES", "")
...
#field("SPECIAL RULES", "Frenzy, Natural Armour (3+)")

- *Earth-shattering Charge:* A Stonehorn has the Impact Hits (D6) special rule. When a Stonehorn makes a successful charge, you may roll 2D6 when determining the number of Impact Hits, and choose the highest result.
- *Stone Skeleton:* If an Attack with the Multiple Wounds special rule successfully wounds a Stonehorn, halve the number of Wounds inflicted (rounding fractions up)
...
#field("BASE SIZE", "100x150")
#field("EQUIPMENT", "Chaintrap, harpoon launcher, gut-plate (Beast Riders only)")
#field("SPECIAL RULES", "Immunity (Ice Attacks), Impact Hits (D6), Natural Armour (4+)")
...
#field("SPECIAL RULES", "Impact Hits (D6+1), Immunity (Psychology), Natural Armour (4+)")
...
- *Overtyrant's Crown:* Talisman. The Overtyrant's Crown gives Greasus a 4+ Ward save. In addition, Greasus and any unit he joins have the Immunity (Psychology) special rule.
...
#field("SPECIAL RULES", "Frenzy (Iron Rhinox only), Impact Hits (D3+1), Natural Armour (3+)")
...
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Groth Onefinger is a Level 4 Wizard that uses spells from the Lore of the Great Maw.")
#field("OPTIONS", "")
...
#field("MAGIC", "Morg Magmaborn is a Level 3 Wizard that uses spells from the Lore of Fire.")
#field("MAGIC ITEMS", "")

- *The Basalt Staff:* Magic Weapon. Morg’s close combat attacks have the Armour Piercing (1) special rule. In addition, the Staff contains a Bound Spell, power level 3, which casts the _Fire Ball_ spell from the Lore of Fire.
...
#entry("GOLGFAG MANEATER", first: true)
#namecost("Mercenary Captain", "")
#profile(
...
#field("TROOP TYPE", "Monstrous Infantry (Special Character, Ogre)")
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Two hand weapons, Ogre pistol, light armour, gut-plate")
#field("OPTIONS", "")
...
- *Golgfag's Maneaters:* Golgfag Maneater must be accompanied by a unit of Maneaters chosen from the army list as normal. The unit must be given a Standard Bearer and Musician. Skaff is the unit's Standard Bearer. Golgfag is the unit's Leader and may never choose to leave this unit.
...
- *Soul-binder Chains:* Magic Weapon. Two hand weapons. At the beginning of each close combat phase, Braugh may nominate one enemy model in base contact. That model loses D3 Attacks for that phase.
...
#field("TROOP TYPE", "Monstrous Infantry (Special Character, Ogre)")
#field("BASE SIZE", "40x40")
#field("EQUIPMENT", "Hand weapon, great throwing spear, gut-plate")
#field("OPTIONS", "")

- May take Magic Items up to a total of 50 points

#field("SPECIAL RULES", "Loner, Ogre Charge, Natural Armour (6+), Scouts, Their Master's Voice (see Hunters)")
