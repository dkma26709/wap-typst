...
_The Signal Fire is the one number here with nothing underneath it, since the book sells no deployment rule at any price. Thirty is reasoning rather than precedent: above the Banner of Ellyrion, which is 25 for a permanent point of Movement and the Strider rule on one named unit of Ellyrian Reavers, because a wing of Blood Wyrms arriving behind the line is worth more than that, and discounted for the two turns it spends off the table._
