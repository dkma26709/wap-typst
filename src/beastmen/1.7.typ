...
*Below are Gifts of Chaos that can be bought for your characters. Each can only be chosen once per army (excluding Special Characters).*

#namecost("CROWN OF HORNS", "35 points")
...
Beastlord or Wargor only. Friendly units of Gors, Ungors and Bestigors within 6" of this character gain +1 Leadership.
...
War Beasts, Swarms and any mounts are not allowed to target the model bearing the Rune of the True Beast in close combat, although any riders may attack as normal.
...
Each time a spell from the Lore of the Wild is cast, all friendly units with the Primal Fury special rule within 6" gain a +1 Leadership bonus to their Primal Fury tests in the following close combat phase. This bonus is cumulative.
...
No Ward saves (except Parry and Dodge) can be taken against Wounds caused by this weapon.
...
#namecost("TROLLHIDE ARMOUR", "30 points")
...
#namecost("BLACKENED PLATE", "10 points")

Medium armour. The wearer of the Blackened Plate gains the Immunity (Flaming Attacks) special rule. Any unit he joins gains a 4+ Ward Save against non- physical Flaming Attacks.
...
#namecost("CHAOS ARMOUR", "10 points")
...
#namecost("FUR OF SHARRGU", "40 points")

This Fur gives the wearer a 5+ Ward save. In addition, they gain the Natural Armour (6+) special rule against missile attacks.
...
The Eye of Night gives the bearer the Magic Resistance (2) special rule. In addition, if an enemy Wizard within 24" suffers a Miscast, you may force them to re-roll the result on the Miscast table.

#namecost("GLYPH-ETCHED TALISMAN", "20 points")

The bearer of this item channels dispel dice in the same manner as a Wizard. This has no effect on a model that already is a Wizard.

#namecost("PELT OF THE DARK YOUNG", "15 points")
...
At the start of each of your Magic phases, pick one terrain feature within 18" of the bearer. Any enemy unit within 6" of that terrain feature suffer D6 Strength 4 Hits.

#namecost("STAFF OF DARKOTH", "25 points")

Bound spell (Power Level 3). The Staff of Darkoth contains the _Viletide_ spell from the Lore of the Wild.
...
One use only. This item may be used at the start of the Remaining Moves sub-phase on your second turn. When used, all friendly units with the Ambushers special rule may re-roll failed attempts to enter the battlefield that turn.
...
The bearer and any unit they have joined gain a +1 bonus to their Strength.
...
#namecost("THE BANNER OF OUTRAGE", "25 points")
...
#namecost("PREYSEEKER", "5 points")

The unit carrying the Preyseeker automatically enters the battlefield when using the Ambushers special rule (no roll is needed).

= LORDS

#entry("BEASTLORD", first: true)
#profile(
...
#field("SPECIAL RULES", "Beastmen Ambush, Forest Strider, Primal Fury")

#entry("GREAT BRAY-SHAMAN")
#profile(
...
#field("MAGIC", "A Great Bray-Shaman is a Level 3 Wizard who uses spells from the Lore of Beasts, Shadow, Death, Wild, or Chaos. A Great Bray-Shaman with the Mark of Nurgle, Slaanesh or Tzeentch must use the Lore of Nurgle, Slaanesh or Tzeentch, respectively.")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Bloodgreed, Impact Hits (D3)")

= HEROES

#entry("WARGOR", first: true)
#profile(
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "A Bray-Shaman is a Level 1 Wizard who uses spells from the Lore of Beasts, Shadow, Death, Wild, or Chaos. A Bray-Shaman with the Mark of Nurgle, Slaanesh or Tzeentch must use the Lore of Nurgle, Slaanesh or Tzeentch, respectively.")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Beastmen Ambush, Drunken, Forest Strider, Primal Fury")
#field("NOTES", "")
...
#field("SPECIAL RULES", "Beastmen Ambush, Forest Strider, Primal Fury, Skirmishers, Unruly")
...
#field("DRAWN BY", "2 Tuskgors (Chaos Beast)")
...
#field("SPECIAL RULES", "Natural Armour (6+), Primal Fury, Thunderous Charge (Tuskgor only)")
...
#field("TROOP TYPE", "Chariot (Armour Save 6+)")
#field("CREW", "1 Gor & 1 Bestigor (Beastmen, Gor)")
#field("DRAWN BY", "1 Razorgor (Chaos Beast)")
#field("BASE SIZE", "50x100")
#field("EQUIPMENT", "Light lance (Gor only), great weapon (Bestigor only), light armour")
#field("OPTIONS", "")
...
#field("SPECIAL RULES", "Fear, Natural Armour (6+), Primal Fury, Thunderous Charge (Razorgor only)")
...
#field("SPECIAL RULES", "Impact Hits (D3), Natural Armour (6+), Thunderous Charge")
]
...
#field("SPECIAL RULES", "Loner, Natural Armour (5+)")
...
#field("SPECIAL RULES", "Frenzy, Impact Hits (D6+2), Natural Armour (4+), Primal Fury (Bestigors only), Stubborn, Thunderous Charge")
]
...
- *Mutant Monstrosity:* The Giant gains the Natural Armour (5+) special rule.
...
- *Cloak of the Beastlord:* Talisman. The Cloak of the Beastlord gives Gorthor a Ward save equal to the Strength of the attack that hit him, to a minimum of 6+. For example, a Strength 3 hit would grant a 3+ Ward save and a Strength 5 hit would grant a 5+ Ward save. Against Attacks that do not have a Strength value, it provides a Ward Save (6+). In addition, he gains the Inspiring Presence (6) special rule.
...
- *Bagrar the Tamer:* If Gorthor is mounted on a Chariot, he may re-roll all Fleeing and Pursuit distance rolls. If Gorthor is on foot, Bagrar is not included in the game.
...
- *Skull-Weave:* Enchanted Item. Morghur causes Terror. Any model attempting to attack Morghur in close combat suffers \-1 to Hit.

#field("SPECIAL RULES", "Beastmen Ambush, Forest Strider, Primal Fury, Random Movement (2D6), Unbreakable")
...
- *The Hordes of Morghur:* A Beastmen army containing Morghur must re-roll all successful Unruly tests.
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Malagor is a Level 4 Wizard who uses spells from the Lore of Beasts, Lore of Shadow, Lore of Death or Lore of the Wild.")
#field("MAGIC ITEMS", "")

- *Icons of Vilification:* Enchanted Item. All friendly units within 6" of Malagor may re-roll failed Primal Fury tests.

#field("SPECIAL RULES", "Beastmen Ambush, Forest Strider, Fly (10), Primal Fury")
...
#field("SPECIAL RULES", "Bloodgreed, Frenzy, Impact Hits (D3+1)")

- *Brass Body:* Taurox has the Natural Armour (2+) special rule. However, if an attack rolls a natural 6 To Hit and then a natural 6 To Wound then Taurox will be slain outright if he fails his saving throw.

= SPECIAL CHARACTERS (HEROES)

#entry("MOLOKH SLUGTONGUE", first: true)
...
#field("BASE SIZE", "25x25 or 30x30")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Molokh Slugtongue is a Level 2 Wizard who uses spells from the Lore of Death or Lore of the Wild.")
#field("SPECIAL RULES", "Beastmen Ambush, Forest Strider, Poisoned Attacks, Primal Fury, Regeneration (4+)")
...
#field("BASE SIZE", "25x50 or 30x60")
#field("EQUIPMENT", "Hand weapon")
#field("MAGIC", "Moonclaw is a Level 1 Wizard who uses spells from the Lore of Shadow or Lore of the Wild.")
#field("SPECIAL RULES", "Forest Strider, Loner, Primal Fury")
...
- *Ward of Morrslieb:* Moonclaw has a 5+ Ward save and the Magic Resistance (2) special rule.
